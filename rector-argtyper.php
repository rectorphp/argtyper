...
return RectorConfig::configure()->withBootstrapFiles([__DIR__ . '/bin/autoload.php'])->withSkip([
    ...
    'test',
    'Tests',
])->withRules([AddFunctionParamTypeRector::class, AddClassMethodParamTypeRector::class]);
