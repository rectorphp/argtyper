...
return RectorConfig::configure()->withBootstrapFiles([__DIR__ . '/bin/autoload.php'])->withRules([AddFunctionParamTypeRector::class, AddClassMethodParamTypeRector::class]);
