...
php -d memory_limit=-1 php-scoper.phar add-prefix config src bin vendor composer.json --output-dir "../$RESULT_DIRECTORY" --config scoper.php --force --ansi --working-dir "$BUILD_DIRECTORY"
