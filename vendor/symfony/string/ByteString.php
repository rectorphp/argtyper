 ...
 */
namespace Argtyper202601\Symfony\Component\String;

use Random\Randomizer;
use Argtyper202601\Symfony\Component\String\Exception\ExceptionInterface;
use Argtyper202601\Symfony\Component\String\Exception\InvalidArgumentException;
use Argtyper202601\Symfony\Component\String\Exception\RuntimeException;
/**
    ...
    public function toCodePointString(?string $fromEncoding = null): CodePointString
    {
        ...
        try {
            try {
                ...
                if (!\function_exists('iconv') && !\function_exists('Argtyper202601\iconv')) {
                    throw $e;
                }
