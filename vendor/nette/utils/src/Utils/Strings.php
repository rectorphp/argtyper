...
namespace SherlockTypes202308\Nette\Utils;

use SherlockTypes202308\JetBrains\PhpStorm\Language;
use SherlockTypes202308\Nette;
...
class Strings
{
     ...
     */
    public static function split(string $subject, string $pattern, $captureOffset = \false, bool $skipEmpty = \false, int $limit = -1, bool $utf8 = \false) : array
    {
     ...
     * @param bool|int $captureOffset
     */
    public static function match(string $subject, string $pattern, $captureOffset = \false, int $offset = 0, bool $unmatchedAsNull = \false, bool $utf8 = \false) : ?array
    {
     ...
     * @param bool|int $captureOffset
     */
    public static function matchAll(string $subject, string $pattern, $captureOffset = \false, int $offset = 0, bool $unmatchedAsNull = \false, bool $patternOrder = \false, bool $utf8 = \false) : array
    {
     ...
     */
    public static function replace(string $subject, $pattern, $replacement = '', int $limit = -1, bool $captureOffset = \false, bool $unmatchedAsNull = \false, bool $utf8 = \false) : string
    {
