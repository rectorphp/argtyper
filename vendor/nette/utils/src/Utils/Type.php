...
namespace Argtyper202601\Nette\Utils;

use Argtyper202601\Nette;
...
final class Type
{
    ...
    {
        return Arrays::every($ourTypes, function ($ourType) use ($givenTypes) {
            return Arrays::some($givenTypes, function ($givenType) use ($ourType) {
