...
namespace Argtyper202511\PHPStan;

use Argtyper202511\Composer\Autoload\ClassLoader;
    ...
    public static final function loadClass(string $class) : void
    {
        ...
        if (!self::$polyfillsLoaded) {
            ...
            if (PHP_VERSION_ID < 80300 && empty($GLOBALS['__composer_autoload_files']['662a729f963d39afe703c9d9b7ab4a8c']) && !class_exists(\Symfony\Polyfill\Php83\Php83::class, \false)) {
                $GLOBALS['__composer_autoload_files']['662a729f963d39afe703c9d9b7ab4a8c'] = \true;
            ...
            if (PHP_VERSION_ID < 80400 && empty($GLOBALS['__composer_autoload_files']['9d2b9fc6db0f153a0a149fefb182415e']) && !class_exists(\Symfony\Polyfill\Php83\Php84::class, \false)) {
                $GLOBALS['__composer_autoload_files']['9d2b9fc6db0f153a0a149fefb182415e'] = \true;
            ...
            if (PHP_VERSION_ID < 80500 && empty($GLOBALS['__composer_autoload_files']['606a39d89246991a373564698c2d8383']) && !class_exists(\Symfony\Polyfill\Php83\Php85::class, \false)) {
                $GLOBALS['__composer_autoload_files']['606a39d89246991a373564698c2d8383'] = \true;
        ...
        if (\strpos($class, 'PHPStan\\BetterReflection\\') === 0) {
            $filename = (string) \substr($filename, \strlen('PHPStan\\BetterReflection\\'));
            $filepath = 'phar://' . __DIR__ . '/phpstan.phar/vendor/ondrejmirtes/better-reflection/src/' . $filename . '.php';
        } else {
            $filename = (string) \substr($filename, \strlen('PHPStan\\'));
