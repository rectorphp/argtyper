 ...
 */
namespace SherlockTypes202308\Composer;

use SherlockTypes202308\Composer\Autoload\ClassLoader;
use SherlockTypes202308\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('SherlockTypes202308\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
