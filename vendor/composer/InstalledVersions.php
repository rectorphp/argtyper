 ...
 */
namespace Argtyper202511\Composer;

use Argtyper202511\Composer\Autoload\ClassLoader;
use Argtyper202511\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Argtyper202511\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
