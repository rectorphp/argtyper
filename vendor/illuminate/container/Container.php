...
namespace SherlockTypes202308\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use SherlockTypes202308\Illuminate\Contracts\Container\BindingResolutionException;
use SherlockTypes202308\Illuminate\Contracts\Container\CircularDependencyException;
use SherlockTypes202308\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
