...
namespace Argtyper202511\Rector\Testing\PHPUnit;

use Argtyper202511\RectorPrefix202511\Illuminate\Container\RewindableGenerator;
use Iterator;
use Argtyper202511\RectorPrefix202511\Nette\Utils\FileSystem;
use Argtyper202511\RectorPrefix202511\Nette\Utils\Strings;
use Argtyper202511\PHPUnit\Framework\ExpectationFailedException;
...
use Argtyper202511\Rector\DependencyInjection\Laravel\ContainerMemento;
...
use Argtyper202511\Rector\Testing\Contract\RectorTestInterface;
use Argtyper202511\Rector\Testing\Fixture\FixtureFileFinder;
use Argtyper202511\Rector\Testing\Fixture\FixtureFileUpdater;
use Argtyper202511\Rector\Testing\Fixture\FixtureSplitter;
use Argtyper202511\Rector\Testing\PHPUnit\ValueObject\RectorTestResult;
use Argtyper202511\Rector\Util\Reflection\PrivatesAccessor;
/**
 * @api used by public
 */
abstract class AbstractRectorTestCase extends \Argtyper202511\Rector\Testing\PHPUnit\AbstractLazyTestCase implements RectorTestInterface
{
    /**
