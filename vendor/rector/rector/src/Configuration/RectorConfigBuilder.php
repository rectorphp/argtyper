...
use Argtyper202511\Rector\Bridge\SetProviderCollector;
use Argtyper202511\Rector\Bridge\SetRectorsResolver;
use Argtyper202511\Rector\Caching\Contract\ValueObject\Storage\CacheStorageInterface;
use Argtyper202511\Rector\Composer\InstalledPackageResolver;
use Argtyper202511\Rector\Config\Level\CodeQualityLevel;
use Argtyper202511\Rector\Config\Level\CodingStyleLevel;
use Argtyper202511\Rector\Config\Level\DeadCodeLevel;
...
use Argtyper202511\Rector\Config\RegisteredService;
use Argtyper202511\Rector\Configuration\Levels\LevelRulesResolver;
use Argtyper202511\Rector\Configuration\Parameter\SimpleParameterProvider;
use Argtyper202511\Rector\Console\Notifier;
...
use Argtyper202511\Rector\Enum\Config\Defaults;
use Argtyper202511\Rector\Exception\Configuration\InvalidConfigurationException;
use Argtyper202511\Rector\Php\PhpVersionResolver\ComposerJsonPhpVersionResolver;
...
use Argtyper202511\Rector\Set\SetManager;
use Argtyper202511\Rector\Set\ValueObject\DowngradeLevelSetList;
use Argtyper202511\Rector\Set\ValueObject\SetList;
use Argtyper202511\Rector\Symfony\Set\SymfonyInternalSetList;
use Argtyper202511\Rector\Symfony\Set\SymfonySetList;
use Argtyper202511\Rector\ValueObject\Configuration\LevelOverflow;
...
final class RectorConfigBuilder
{
     ...
     * @var int
     */
    private $parallelMaxNumberOfProcess = Defaults::PARALLEL_MAX_NUMBER_OF_PROCESS;
    /**
     * @var int
     */
     ...
     * @var bool|null
     */
    private $isTypeCoverageDocblockLevelUsed;
    /**
     * @var bool|null
     */
     ...
     * @var bool|null
     */
    private $isCodingStyleLevelUsed;
    /**
     * @var bool|null
     */
    ...
    public function __invoke(RectorConfig $rectorConfig): void
    {
        if ($this->setGroups !== [] || $this->setProviders !== []) {
            ...
            SimpleParameterProvider::addParameter(\Argtyper202511\Rector\Configuration\Option::COMPOSER_BASED_SETS, $this->groupLoadedSets);
        }
        ...
        SimpleParameterProvider::addParameter(\Argtyper202511\Rector\Configuration\Option::SET_REGISTERED_RULES, $setRegisteredRectorClasses);
        if ($this->paths !== []) {
    ...
    public function withAttributesSets(bool $symfony = \false, bool $doctrine = \false, bool $mongoDb = \false, bool $gedmo = \false, bool $phpunit = \false, bool $fosRest = \false, bool $jms = \false, bool $sensiolabs = \false, bool $behat = \false, bool $all = \false, bool $symfonyRoute = \false, bool $symfonyValidator = \false): self
    {
        ...
        if ($symfonyRoute) {
            ...
            $this->withConfiguredRule(AnnotationToAttributeRector::class, [new AnnotationToAttribute('Argtyper202511\Symfony\Component\Routing\Annotation\Route')]);
        }
        if ($symfonyValidator) {
            if ($symfony) {
    ...
    ): self
    {
        ...
        if ($pickedArguments === []) {
            ...
            $phpLevelSets = \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion($projectPhpVersion);
        ...
        $phpLevelSets = \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion($targetPhpVersion);
        $this->sets = array_merge($this->sets, $phpLevelSets);
        return $this;
    }
    /**
    ...
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_53));
        return $this;
    }
    public function withPhp54Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_54));
        return $this;
    }
    public function withPhp55Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_55));
        return $this;
    }
    public function withPhp56Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_56));
        return $this;
    }
    public function withPhp70Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_70));
        return $this;
    }
    public function withPhp71Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_71));
        return $this;
    }
    public function withPhp72Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_72));
        return $this;
    }
    public function withPhp73Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_73));
        return $this;
    }
    public function withPhp74Sets(): self
    {
        $this->isWithPhpSetsUsed = \true;
        $this->sets = array_merge($this->sets, \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion(PhpVersion::PHP_74));
        return $this;
    }
    ...
    public function withRules(array $rules): self
    {
        ...
        if (SimpleParameterProvider::provideBoolParameter(\Argtyper202511\Rector\Configuration\Option::IS_RECTORCONFIG_BUILDER_RECREATED, \false) === \false) {
            ...
            $nonConfigurableRules = array_filter($rules, function (string $rule): bool {
                return !is_a($rule, ConfigurableRectorInterface::class, \true);
            });
            SimpleParameterProvider::addParameter(\Argtyper202511\Rector\Configuration\Option::ROOT_STANDALONE_REGISTERED_RULES, $nonConfigurableRules);
        }
        return $this;
    }
    /**
    ...
    public function withPhpLevel(int $level): self
    {
        ...
        $setFilePaths = \Argtyper202511\Rector\Configuration\PhpLevelSetResolver::resolveFromPhpVersion($phpVersion);
