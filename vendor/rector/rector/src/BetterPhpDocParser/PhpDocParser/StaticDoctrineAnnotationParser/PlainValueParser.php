...
namespace Argtyper202511\Rector\BetterPhpDocParser\PhpDocParser\StaticDoctrineAnnotationParser;
...
final class PlainValueParser
{
    ...
    public function autowire(StaticDoctrineAnnotationParser $staticDoctrineAnnotationParser, \Argtyper202511\Rector\BetterPhpDocParser\PhpDocParser\StaticDoctrineAnnotationParser\ArrayParser $arrayParser) : void
    {
    ...
    private function matchConstantValue(string $currentTokenValue) : ?\Argtyper202511\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprNode
    {
