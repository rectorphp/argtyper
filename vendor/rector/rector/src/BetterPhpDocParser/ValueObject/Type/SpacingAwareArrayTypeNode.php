...
final class SpacingAwareArrayTypeNode extends ArrayTypeNode
{
    public function __toString(): string
    {
        ...
        if ($this->type instanceof \Argtyper202511\Rector\BetterPhpDocParser\ValueObject\Type\BracketsAwareUnionTypeNode) {
    ...
    private function printUnionType(\Argtyper202511\Rector\BetterPhpDocParser\ValueObject\Type\BracketsAwareUnionTypeNode $bracketsAwareUnionTypeNode): string
    {
