...
final class PhpDocClassRenamer
{
    ...
    {
        $assertChoiceDoctrineAnnotationTagValueNode = $phpDocInfo->findOneByAnnotationClass('Argtyper202601\Symfony\Component\Validator\Constraints\Choice');
    ...
    {
        $doctrineAnnotationTagValueNode = $phpDocInfo->getByAnnotationClasses(['Argtyper202601\Doctrine\ORM\Mapping\OneToMany', 'Argtyper202601\Doctrine\ORM\Mapping\ManyToMany', 'Argtyper202601\Doctrine\ORM\Mapping\Embedded']);
    ...
    {
        $classKey = $doctrineAnnotationTagValueNode->hasClassName('Argtyper202601\Doctrine\ORM\Mapping\Embedded') ? 'class' : 'targetEntity';
