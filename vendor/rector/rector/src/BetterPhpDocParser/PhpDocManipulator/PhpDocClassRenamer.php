...
namespace Argtyper202511\Rector\BetterPhpDocParser\PhpDocManipulator;
...
use Argtyper202511\Rector\BetterPhpDocParser\PhpDocParser\ClassAnnotationMatcher;
...
final class PhpDocClassRenamer
{
    ...
    {
        $assertChoiceDoctrineAnnotationTagValueNode = $phpDocInfo->findOneByAnnotationClass('Argtyper202511\Symfony\Component\Validator\Constraints\Choice');
    ...
    {
        $doctrineAnnotationTagValueNode = $phpDocInfo->getByAnnotationClasses(['Argtyper202511\Doctrine\ORM\Mapping\OneToMany', 'Argtyper202511\Doctrine\ORM\Mapping\ManyToMany', 'Argtyper202511\Doctrine\ORM\Mapping\Embedded']);
    ...
    {
        $classKey = $doctrineAnnotationTagValueNode->hasClassName('Argtyper202511\Doctrine\ORM\Mapping\Embedded') ? 'class' : 'targetEntity';
