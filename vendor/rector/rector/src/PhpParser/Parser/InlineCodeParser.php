...
final class InlineCodeParser
{
    ...
    public function __construct(BetterStandardPrinter $betterStandardPrinter, \Argtyper202511\Rector\PhpParser\Parser\SimplePhpParser $simplePhpParser, ValueResolver $valueResolver)
    {
