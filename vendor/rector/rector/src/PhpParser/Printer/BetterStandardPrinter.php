...
namespace Argtyper202511\Rector\PhpParser\Printer;
...
use Argtyper202511\PHPStan\Node\AnonymousClassNode;
use Argtyper202511\PHPStan\Node\Expr\AlwaysRememberedExpr;
...
use Argtyper202511\Rector\Util\NewLineSplitter;
...
final class BetterStandardPrinter extends Standard
{
    ...
    private function cleanVariadicPlaceHolderTrailingComma(CallLike $callLike) : void
    {
        ...
        while (isset($tokens[$callLike->getEndTokenPos() - $iteration])) {
            $text = \trim((string) $tokens[$callLike->getEndTokenPos() - $iteration]->text);
