...
namespace Argtyper202511\Rector\PhpParser\Node\Value;

use ArithmeticError;
use Argtyper202511\PhpParser\ConstExprEvaluationException;
use Argtyper202511\PhpParser\ConstExprEvaluator;
...
use Argtyper202511\PhpParser\Node\Scalar\MagicConst\Class_;
...
use Argtyper202511\Rector\NodeAnalyzer\ConstFetchAnalyzer;
use Argtyper202511\Rector\NodeNameResolver\NodeNameResolver;
use Argtyper202511\Rector\NodeTypeResolver\Node\AttributeKey;
use Argtyper202511\Rector\NodeTypeResolver\NodeTypeResolver;
use Argtyper202511\Rector\Reflection\ClassReflectionAnalyzer;
...
final class ValueResolver
{
    ...
    private function resolveDirConstant() : string
    {
        ...
        if (!$file instanceof \Argtyper202511\Rector\ValueObject\Application\File) {
