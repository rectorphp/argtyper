...
use Argtyper202511\PHPStan\Type\BenevolentUnionType;
...
final class ReflectionResolver
{
    ...
    public function __construct(ReflectionProvider $reflectionProvider, NodeTypeResolver $nodeTypeResolver, NodeNameResolver $nodeNameResolver, ClassAnalyzer $classAnalyzer, \Argtyper202511\Rector\Reflection\MethodReflectionResolver $methodReflectionResolver)
    {
