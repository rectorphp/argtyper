...
final class MissConfigurationReporter
{
    ...
    public function reportSkippedNeverRegisteredRules(): void
    {
        ...
        $neverRegisteredSkippedRules = array_filter($neverRegisteredSkippedRules, function ($skippedRule): bool {
