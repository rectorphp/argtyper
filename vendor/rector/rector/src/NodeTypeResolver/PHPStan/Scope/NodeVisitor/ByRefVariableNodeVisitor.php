...
final class ByRefVariableNodeVisitor extends NodeVisitorAbstract implements ScopeResolverNodeVisitorInterface
{
    ...
    public function enterNode(Node $node): ?Node
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($stmts, function (Node $subNode) use (&$byRefVariableNames): ?\Argtyper202511\PhpParser\Node\Expr\Variable {
