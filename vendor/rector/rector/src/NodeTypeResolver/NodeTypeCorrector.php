...
use Argtyper202511\Rector\NodeTypeResolver\NodeTypeCorrector\AccessoryNonEmptyArrayTypeCorrector;
use Argtyper202511\Rector\NodeTypeResolver\NodeTypeCorrector\AccessoryNonEmptyStringTypeCorrector;
use Argtyper202511\Rector\NodeTypeResolver\NodeTypeCorrector\GenericClassStringTypeCorrector;
/**
...
final class NodeTypeCorrector
{
    ...
    /**
     * @readonly
     * @var \Rector\NodeTypeResolver\NodeTypeCorrector\AccessoryNonEmptyArrayTypeCorrector
     */
    private $accessoryNonEmptyArrayTypeCorrector;
