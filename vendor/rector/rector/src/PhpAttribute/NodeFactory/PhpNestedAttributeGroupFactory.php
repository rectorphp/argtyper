...
final class PhpNestedAttributeGroupFactory
{
    ...
    public function __construct(AnnotationToAttributeMapper $annotationToAttributeMapper, \Argtyper202511\Rector\PhpAttribute\NodeFactory\AttributeNameFactory $attributeNameFactory, \Argtyper202511\Rector\PhpAttribute\NodeFactory\NamedArgsFactory $namedArgsFactory, AttributeArrayNameInliner $attributeArrayNameInliner, TokenIteratorFactory $tokenIteratorFactory, StaticDoctrineAnnotationParser $staticDoctrineAnnotationParser)
    {
