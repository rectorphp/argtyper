...
use Argtyper202511\RectorPrefix202511\Nette\Utils\FileSystem as UtilsFileSystem;
...
use Argtyper202511\Rector\FileSystem\FilesFinder;
use Argtyper202511\Rector\Parallel\Application\ParallelFileProcessor;
use Argtyper202511\Rector\PhpParser\Parser\ParserErrors;
use Argtyper202511\Rector\Reporting\MissConfigurationReporter;
use Argtyper202511\Rector\Testing\PHPUnit\StaticPHPUnitEnvironment;
use Argtyper202511\Rector\Util\ArrayParametersMerger;
...
use Argtyper202511\RectorPrefix202511\Symplify\EasyParallel\CpuCoreCountProvider;
use Argtyper202511\RectorPrefix202511\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use Argtyper202511\RectorPrefix202511\Symplify\EasyParallel\ScheduleFactory;
use Throwable;
final class ApplicationFileProcessor
{
    ...
    /**
     * @readonly
     * @var \RectorPrefix202511\Symplify\EasyParallel\ScheduleFactory
     */
    private $scheduleFactory;
    /**
     * @readonly
     * @var \RectorPrefix202511\Symplify\EasyParallel\CpuCoreCountProvider
     */
