...
final class IfManipulator
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, \Argtyper202511\Rector\NodeManipulator\StmtsManipulator $stmtsManipulator, ValueResolver $valueResolver, NodeComparator $nodeComparator)
    {
