...
final class ClassDependencyManipulator
{
     ...
     */
    private $astResolver;
    public function __construct(\Argtyper202511\Rector\NodeManipulator\ClassInsertManipulator $classInsertManipulator, \Argtyper202511\Rector\NodeManipulator\ClassMethodAssignManipulator $classMethodAssignManipulator, NodeFactory $nodeFactory, \Argtyper202511\Rector\NodeManipulator\StmtsManipulator $stmtsManipulator, PhpVersionProvider $phpVersionProvider, PropertyPresenceChecker $propertyPresenceChecker, NodeNameResolver $nodeNameResolver, AutowiredClassMethodOrPropertyAnalyzer $autowiredClassMethodOrPropertyAnalyzer, ReflectionResolver $reflectionResolver, AstResolver $astResolver)
    {
    ...
    private function resolveConstruct(Class_ $class): ?ClassMethod
    {
        ...
        $ancestors = array_filter($classReflection->getAncestors(), static function (ClassReflection $ancestor) use ($classReflection): bool {
            return $ancestor->getName() !== $classReflection->getName();
        });
