...
final class ClassMethodPropertyFetchManipulator
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, NodeNameResolver $nodeNameResolver, \Argtyper202511\Rector\NodeManipulator\FunctionLikeManipulator $functionLikeManipulator)
    {
