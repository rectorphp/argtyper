...
final class FileCacheStorage implements CacheStorageInterface
{
    ...
    /**
     * @readonly
     * @var \RectorPrefix202512\Symfony\Component\Filesystem\Filesystem
     */
    private $filesystem;
    public function __construct(string $directory, \RectorPrefix202512\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
