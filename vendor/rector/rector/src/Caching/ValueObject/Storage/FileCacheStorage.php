...
namespace Argtyper202511\Rector\Caching\ValueObject\Storage;
...
use Argtyper202511\Rector\Caching\ValueObject\CacheFilePaths;
use Argtyper202511\Rector\Caching\ValueObject\CacheItem;
use Argtyper202511\Rector\Exception\Cache\CachingException;
/**
...
final class FileCacheStorage implements CacheStorageInterface
{
     ...
     */
    private $filesystem;
    public function __construct(string $directory, \Argtyper202511\RectorPrefix202511\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
