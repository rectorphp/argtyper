...
final class NullablePhpDocTypeMapper implements PhpDocTypeMapperInterface
{
    ...
    public function __construct(\Argtyper202511\Rector\StaticTypeMapper\PhpDocParser\IdentifierPhpDocTypeMapper $identifierPhpDocTypeMapper, TypeNodeResolver $typeNodeResolver)
    {
