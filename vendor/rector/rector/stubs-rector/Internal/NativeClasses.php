...
if (\PHP_VERSION_ID < 80000 && !\class_exists('ReflectionUnionType', \false)) {
    ...
    \class_alias('Argtyper202511\ReflectionUnionType', 'ReflectionUnionType', \false);
}
if (\PHP_VERSION_ID < 80000 && !\class_exists('ReflectionAttribute', \false)) {
    ...
    \class_alias('Argtyper202511\ReflectionAttribute', 'ReflectionAttribute', \false);
}
if (\PHP_VERSION_ID < 80000 && !\class_exists('Attribute', \false)) {
    ...
    \class_alias('Argtyper202511\Attribute', 'Attribute', \false);
}
if (\PHP_VERSION_ID < 80100 && !\class_exists('ReturnTypeWillChange', \false)) {
    ...
    \class_alias('Argtyper202511\ReturnTypeWillChange', 'ReturnTypeWillChange', \false);
}
if (\PHP_VERSION_ID < 80100 && !\class_exists('ReflectionIntersectionType', \false)) {
    ...
    \class_alias('Argtyper202511\ReflectionIntersectionType', 'ReflectionIntersectionType', \false);
}
