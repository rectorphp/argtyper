...
namespace Argtyper202511\RectorPrefix202510;

use Argtyper202511\RectorPrefix202510\Nette\Loaders\RobotLoader;
use Argtyper202511\Rector\Bridge\SetRectorsResolver;
use Argtyper202511\RectorPrefix202510\Symfony\Component\Console\Input\ArrayInput;
use Argtyper202511\RectorPrefix202510\Symfony\Component\Console\Output\ConsoleOutput;
use Argtyper202511\RectorPrefix202510\Symfony\Component\Console\Style\SymfonyStyle;
use Argtyper202511\RectorPrefix202510\Symfony\Component\Finder\Finder;
use Argtyper202511\RectorPrefix202510\Symfony\Component\Finder\SplFileInfo;
use Argtyper202511\RectorPrefix202510\Webmozart\Assert\Assert;
...
\class_alias('Argtyper202511\RectorClassFinder', 'Argtyper202511\RectorClassFinder', \false);
final class RectorSetFinder
{
    ...
    public function find(array $configDirs): array
    {
        ...
        $setFileInfos = \iterator_to_array(is_array($finder->getIterator()) ? new \ArrayIterator($finder->getIterator()) : $finder->getIterator());
        $setFiles = [];
...
\class_alias('Argtyper202511\RectorSetFinder', 'Argtyper202511\RectorSetFinder', \false);
...
\class_alias('Argtyper202511\UsedRectorClassResolver', 'Argtyper202511\UsedRectorClassResolver', \false);
