...
class Param extends NodeAbstract
{
     ...
     */
    public function __construct(\PhpParser\Node\Expr $var, ?\PhpParser\Node\Expr $default = null, ?Node $type = null, bool $byRef = \false, bool $variadic = \false, array $attributes = [], int $flags = 0, array $attrGroups = [], array $hooks = [])
    {
