...
namespace Argtyper202511\PhpParser\Lexer;

use Argtyper202511\PhpParser\Error;
use Argtyper202511\PhpParser\ErrorHandler;
use Argtyper202511\PhpParser\Lexer;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Argtyper202511\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
