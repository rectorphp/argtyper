...
class Float_ extends Scalar
{
     ...
     */
    public static function fromString(string $str, array $attributes = []) : \Argtyper202511\PhpParser\Node\Scalar\Float_
    {
        $attributes['rawValue'] = $str;
        $float = self::parse($str);
        return new \Argtyper202511\PhpParser\Node\Scalar\Float_($float, $attributes);
    }
    /**
     * @internal
     *
...
\class_alias(\Argtyper202511\PhpParser\Node\Scalar\Float_::class, \Argtyper202511\PhpParser\Node\Scalar\DNumber::class);
