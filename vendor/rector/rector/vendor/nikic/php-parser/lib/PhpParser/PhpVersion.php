...
class PhpVersion
{
     ...
     */
    public function equals(\Argtyper202511\PhpParser\PhpVersion $other): bool
    {
     ...
     */
    public function newerOrEqual(\Argtyper202511\PhpParser\PhpVersion $other): bool
    {
        return $this->id >= $other->id;
    }
    /**
     ...
     */
    public function older(\Argtyper202511\PhpParser\PhpVersion $other): bool
    {
        return $this->id < $other->id;
    }
    /**
