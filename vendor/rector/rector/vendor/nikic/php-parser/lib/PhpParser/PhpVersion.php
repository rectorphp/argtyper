...
class PhpVersion
{
     ...
     */
    public function equals(\PhpParser\PhpVersion $other): bool
    {
     ...
     */
    public function newerOrEqual(\PhpParser\PhpVersion $other): bool
    {
        return $this->id >= $other->id;
    }
    /**
     ...
     */
    public function older(\PhpParser\PhpVersion $other): bool
    {
        return $this->id < $other->id;
    }
    /**
