...
class JsonDecoder
{
    ...
    private function decodeNode(array $value): \Argtyper202511\PhpParser\Node
    {
    ...
    private function decodeComment(array $value): \Argtyper202511\PhpParser\Comment
    {
        $className = $value['nodeType'] === 'Comment' ? \Argtyper202511\PhpParser\Comment::class : \Argtyper202511\PhpParser\Comment\Doc::class;
        if (!isset($value['text'])) {
