...
class ConstExprEvaluator
{
    ...
    public function __construct(?callable $fallbackEvaluator = null)
    {
        $this->fallbackEvaluator = $fallbackEvaluator ?? function (Expr $expr) {
            throw new \Argtyper202511\PhpParser\ConstExprEvaluationException("Expression of type {$expr->getType()} cannot be evaluated");
        };
    }
    /**
    ...
    public function evaluateSilently(Expr $expr)
    {
        ...
        try {
            ...
            if (!$e instanceof \Argtyper202511\PhpParser\ConstExprEvaluationException) {
                $e = new \Argtyper202511\PhpParser\ConstExprEvaluationException("An error occurred during constant expression evaluation", 0, $e);
            }
            throw $e;
        } finally {
