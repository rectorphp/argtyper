...
class Status
{
    ...
    public function __construct(string $envAllowXdebug, bool $debug)
    {
        ...
        \RectorPrefix202512\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART);
    ...
    {
        $this->output($this->getLoadedMessage());
        \RectorPrefix202512\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART, (string) microtime(\true));
    }
    /**
