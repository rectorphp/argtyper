...
class PhpConfig
{
    ...
    {
        $data = \RectorPrefix202512\Composer\XdebugHandler\XdebugHandler::getRestartSettings();
        if ($data !== null) {
    ...
    {
        \RectorPrefix202512\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
