...
class Preg
{
    ...
    public static function match(string $pattern, string $subject, ?array &$matches = null, int $flags = 0, int $offset = 0): int
    {
        ...
        if ($result === \false) {
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_match', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function matchAll(string $pattern, string $subject, ?array &$matches = null, int $flags = 0, int $offset = 0): int
    {
        ...
        if (!is_int($result)) {
            ...
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_match_all', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replace($pattern, $replacement, $subject, int $limit = -1, ?int &$count = null): string
    {
        ...
        if ($result === null) {
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_replace', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replaceCallback($pattern, callable $replacement, $subject, int $limit = -1, ?int &$count = null, int $flags = 0): string
    {
        ...
        if ($result === null) {
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_replace_callback', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function replaceCallbackArray(array $pattern, $subject, int $limit = -1, ?int &$count = null, int $flags = 0): string
    {
        ...
        if ($result === null) {
            ...
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_replace_callback_array', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function split(string $pattern, string $subject, int $limit = -1, int $flags = 0): array
    {
        ...
        if ($result === \false) {
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_split', $pattern);
        }
        return $result;
    }
    /**
    ...
    public static function grep(string $pattern, array $array, int $flags = 0): array
    {
        ...
        if ($result === \false) {
            throw \RectorPrefix202511\Composer\Pcre\PcreException::fromFunction('preg_grep', $pattern);
        }
        return $result;
    }
    /**
    ...
    private static function enforceNonNullMatches(string $pattern, array $matches, string $variantMethod)
    {
        foreach ($matches as $group => $match) {
            ...
            throw new \RectorPrefix202511\Composer\Pcre\UnexpectedNullMatchException('Pattern "' . $pattern . '" had an unexpected unmatched group "' . $group . '", make sure the pattern always matches or use ' . $variantMethod . '() instead.');
        }
        /** @var array<string> */
        return $matches;
    }
