...
final class OnlyInPowerShellFinder implements \RectorPrefix202512\Fidry\CpuCoreCounter\Finder\CpuCoreFinder
{
    /**
     * @var CpuCoreFinder
     */
    private $decoratedFinder;
    public function __construct(\RectorPrefix202512\Fidry\CpuCoreCounter\Finder\CpuCoreFinder $decoratedFinder)
    {
