...
use RectorPrefix202512\Fidry\CpuCoreCounter\Executor\ProcessExecutor;
use RectorPrefix202512\Fidry\CpuCoreCounter\Executor\ProcOpenExecutor;
...
use const PHP_EOL;
abstract class ProcOpenBasedFinder implements \RectorPrefix202512\Fidry\CpuCoreCounter\Finder\CpuCoreFinder
{
    /**
     * @var ProcessExecutor
     */
