...
final class CpuCoreCounter
{
     ...
     */
    public function getAvailableForParallelisation(int $reservedCpus = 0, ?int $countLimit = null, ?float $loadLimit = null, ?float $systemLoadAverage = 0.0): \RectorPrefix202512\Fidry\CpuCoreCounter\ParallelisationResult
    {
        ...
        return new \RectorPrefix202512\Fidry\CpuCoreCounter\ParallelisationResult($reservedCpus, $countLimit, $loadLimit, $systemLoadAverage, $correctedCountLimit, $correctedSystemLoadAverage ?? $systemLoadAverage, $totalCoreCount, (int) $availableCores);
    }
    /**
    ...
    public function getCountWithFallback(int $fallback): int
    {
        ...
        } catch (\RectorPrefix202512\Fidry\CpuCoreCounter\NumberOfCpuCoreNotFound $exception) {
            return $fallback;
        }
    }
    /**
    ...
    private function findCount(): int
    {
        ...
        throw \RectorPrefix202512\Fidry\CpuCoreCounter\NumberOfCpuCoreNotFound::create();
    }
    /**
     * @throws NumberOfCpuCoreNotFound
     *
