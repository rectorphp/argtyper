...
final class ProcessPool
{
    /**
     * @readonly
     * @var \RectorPrefix202511\React\Socket\TcpServer
     */
    private $tcpServer;
    /**
    ...
    public function getProcess(string $identifier): \RectorPrefix202511\Symplify\EasyParallel\ValueObject\ParallelProcess
    {
    ...
    public function attachProcess(string $identifier, \RectorPrefix202511\Symplify\EasyParallel\ValueObject\ParallelProcess $parallelProcess): void
    {
