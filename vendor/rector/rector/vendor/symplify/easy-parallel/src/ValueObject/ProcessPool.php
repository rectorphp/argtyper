...
final class ProcessPool
{
    /**
     * @readonly
     * @var \RectorPrefix202512\React\Socket\TcpServer
     */
    private $tcpServer;
    /**
    ...
    public function getProcess(string $identifier): \RectorPrefix202512\Symplify\EasyParallel\ValueObject\ParallelProcess
    {
    ...
    public function attachProcess(string $identifier, \RectorPrefix202512\Symplify\EasyParallel\ValueObject\ParallelProcess $parallelProcess): void
    {
