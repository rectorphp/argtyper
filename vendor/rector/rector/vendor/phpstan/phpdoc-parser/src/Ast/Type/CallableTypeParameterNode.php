...
class CallableTypeParameterNode implements Node
{
     ...
     */
    public $isOptional;
    public function __construct(\Argtyper202511\PHPStan\PhpDocParser\Ast\Type\TypeNode $type, bool $isReference, bool $isVariadic, string $parameterName, bool $isOptional)
    {
        $this->type = $type;
