...
final class NodeTraverser
{
     ...
     */
    private function traverseNode(\Argtyper202511\PHPStan\PhpDocParser\Ast\Node $node) : \Argtyper202511\PHPStan\PhpDocParser\Ast\Node
    {
        ...
        foreach ($subNodeNames as $name) {
            ...
            if (is_array($subNode)) {
            ...
            } elseif ($subNode instanceof \Argtyper202511\PHPStan\PhpDocParser\Ast\Node) {
                ...
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    ...
                    if ($return instanceof \Argtyper202511\PHPStan\PhpDocParser\Ast\Node) {
    ...
    private function traverseArray(array $nodes) : array
    {
        ...
        foreach ($nodes as $i => &$node) {
            if ($node instanceof \Argtyper202511\PHPStan\PhpDocParser\Ast\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
    ...
    private function ensureReplacementReasonable(\Argtyper202511\PHPStan\PhpDocParser\Ast\Node $old, \Argtyper202511\PHPStan\PhpDocParser\Ast\Node $new) : void
    {
