...
class GenericTypeNode implements \Argtyper202511\PHPStan\PhpDocParser\Ast\Type\TypeNode
{
     ...
     */
    public function __construct(\Argtyper202511\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode $type, array $genericTypes, array $variances = [])
    {
        $this->type = $type;
