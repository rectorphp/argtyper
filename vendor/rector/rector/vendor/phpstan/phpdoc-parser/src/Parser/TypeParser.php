...
class TypeParser
{
    ...
    public function __construct(ParserConfig $config, \Argtyper202511\PHPStan\PhpDocParser\Parser\ConstExprParser $constExprParser)
    {
        $this->config = $config;
        $this->constExprParser = $constExprParser;
    }
    /** @phpstan-impure */
    public function parse(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\TypeNode
    {
        ...
        if ($tokens->isCurrentTokenType(Lexer::TOKEN_NULLABLE)) {
            ...
            } catch (\Argtyper202511\PHPStan\PhpDocParser\Parser\ParserException $parserException) {
                $enrichedType = null;
            }
    ...
    /** @phpstan-impure */
    private function enrichTypeOnUnionOrIntersection(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type) : ?Ast\Type\TypeNode
    {
     ...
     * @return T
     */
    public function enrichWithAttributes(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Node $type, int $startLine, int $startIndex) : Ast\Node
    {
    ...
    /** @phpstan-impure */
    private function subParse(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\TypeNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
        if ($tokens->isCurrentTokenType(Lexer::TOKEN_NULLABLE)) {
    ...
    /** @phpstan-impure */
    private function parseAtomic(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\TypeNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
    ...
    /** @phpstan-impure */
    private function parseUnion(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type) : Ast\Type\TypeNode
    {
        $types = [$type];
    ...
    /** @phpstan-impure */
    private function subParseUnion(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type) : Ast\Type\TypeNode
    {
        $types = [$type];
        while ($tokens->tryConsumeTokenType(Lexer::TOKEN_UNION)) {
            $tokens->skipNewLineTokensAndConsumeComments();
    ...
    /** @phpstan-impure */
    private function parseIntersection(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type) : Ast\Type\TypeNode
    {
        $types = [$type];
    ...
    /** @phpstan-impure */
    private function subParseIntersection(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type) : Ast\Type\TypeNode
    {
        $types = [$type];
        while ($tokens->tryConsumeTokenType(Lexer::TOKEN_INTERSECTION)) {
            $tokens->skipNewLineTokensAndConsumeComments();
    ...
    /** @phpstan-impure */
    private function parseConditional(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $subjectType) : Ast\Type\TypeNode
    {
    ...
    /** @phpstan-impure */
    private function parseConditionalForParameter(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, string $parameterName) : Ast\Type\TypeNode
    {
    ...
    /** @phpstan-impure */
    private function parseNullable(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\TypeNode
    {
        $tokens->consumeTokenType(Lexer::TOKEN_NULLABLE);
        $type = $this->parseAtomic($tokens);
    ...
    /** @phpstan-impure */
    public function isHtml(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : bool
    {
    ...
    /** @phpstan-impure */
    public function parseGeneric(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\IdentifierTypeNode $baseType) : Ast\Type\GenericTypeNode
    {
        $tokens->consumeTokenType(Lexer::TOKEN_OPEN_ANGLE_BRACKET);
        $tokens->skipNewLineTokensAndConsumeComments();
     ...
     */
    public function parseGenericTypeArgument(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : array
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
     ...
     */
    public function parseTemplateTagValue(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, ?callable $parseDescription = null) : TemplateTagValueNode
    {
    ...
    /** @phpstan-impure */
    private function parseCallable(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\IdentifierTypeNode $identifier, bool $hasTemplate) : Ast\Type\TypeNode
    {
     ...
     * @phpstan-impure
     */
    private function parseCallableTemplates(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : array
    {
        $tokens->consumeTokenType(Lexer::TOKEN_OPEN_ANGLE_BRACKET);
        $templates = [];
        $isFirst = \true;
    ...
    private function parseCallableTemplateArgument(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\PhpDoc\TemplateTagValueNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
    ...
    /** @phpstan-impure */
    private function parseCallableParameter(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\CallableTypeParameterNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
        $type = $this->parse($tokens);
    ...
    /** @phpstan-impure */
    private function parseCallableReturnType(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\TypeNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
        if ($tokens->isCurrentTokenType(Lexer::TOKEN_NULLABLE)) {
    ...
    /** @phpstan-impure */
    private function tryParseCallable(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\IdentifierTypeNode $identifier, bool $hasTemplate) : Ast\Type\TypeNode
    {
        try {
            $tokens->pushSavePoint();
    ...
    /** @phpstan-impure */
    private function tryParseArrayOrOffsetAccess(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type) : Ast\Type\TypeNode
    {
     ...
     */
    private function parseArrayShape(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens, Ast\Type\TypeNode $type, string $kind) : Ast\Type\ArrayShapeNode
    {
    ...
    /** @phpstan-impure */
    private function parseArrayShapeItem(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\ArrayShapeItemNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
     ...
     */
    private function parseArrayShapeKey(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens)
    {
        $startIndex = $tokens->currentTokenIndex();
        $startLine = $tokens->currentTokenLine();
        if ($tokens->isCurrentTokenType(Lexer::TOKEN_INTEGER)) {
            ...
            $key = new Ast\ConstExpr\ConstExprStringNode(\Argtyper202511\PHPStan\PhpDocParser\Parser\StringUnescaper::unescapeString($tokens->currentTokenValue()), Ast\ConstExpr\ConstExprStringNode::DOUBLE_QUOTED);
            $tokens->next();
        } else {
     ...
     * @phpstan-impure
     */
    private function parseArrayShapeUnsealedType(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\ArrayShapeUnsealedTypeNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
        $tokens->consumeTokenType(Lexer::TOKEN_OPEN_ANGLE_BRACKET);
     ...
     * @phpstan-impure
     */
    private function parseListShapeUnsealedType(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\ArrayShapeUnsealedTypeNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
        $tokens->consumeTokenType(Lexer::TOKEN_OPEN_ANGLE_BRACKET);
     ...
     * @phpstan-impure
     */
    private function parseObjectShape(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\ObjectShapeNode
    {
        $tokens->consumeTokenType(Lexer::TOKEN_OPEN_CURLY_BRACKET);
        $items = [];
        do {
    ...
    /** @phpstan-impure */
    private function parseObjectShapeItem(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens) : Ast\Type\ObjectShapeItemNode
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
        $tokens->skipNewLineTokensAndConsumeComments();
     ...
     */
    private function parseObjectShapeKey(\Argtyper202511\PHPStan\PhpDocParser\Parser\TokenIterator $tokens)
    {
        $startLine = $tokens->currentTokenLine();
        $startIndex = $tokens->currentTokenIndex();
