...
namespace Argtyper202511\PHPStan\PhpDocParser\Printer;

use LogicException;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Attribute;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Comment;
use Argtyper202511\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprArrayNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Node;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\AssertTagMethodValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\AssertTagPropertyValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\AssertTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\Doctrine\DoctrineAnnotation;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\Doctrine\DoctrineArgument;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\Doctrine\DoctrineArray;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\Doctrine\DoctrineArrayItem;
...
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\MethodTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\MethodTagValueParameterNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\ParamClosureThisTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\ParamImmediatelyInvokedCallableTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\ParamLaterInvokedCallableTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\ParamOutTagValueNode;
...
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\PureUnlessCallableIsImpureTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\RequireExtendsTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\RequireImplementsTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\ReturnTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\SealedTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\SelfOutTagValueNode;
...
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\TypeAliasImportTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\TypeAliasTagValueNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode;
...
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ArrayShapeUnsealedTypeNode;
...
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\CallableTypeParameterNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeForParameterNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
...
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\InvalidTypeNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ObjectShapeItemNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\ObjectShapeNode;
use Argtyper202511\PHPStan\PhpDocParser\Ast\Type\OffsetAccessTypeNode;
...
final class Printer
{
    ...
    {
        $this->differ = new \Argtyper202511\PHPStan\PhpDocParser\Printer\Differ(static function ($a, $b) {
    ...
    private function printArrayFormatPreserving(array $nodes, array $originalNodes, TokenIterator $originalTokens, int &$tokenIndex, string $parentNodeClass, string $subNodeName) : ?string
    {
        ...
        foreach ($diff as $i => $diffElem) {
            ...
            if ($diffType === \Argtyper202511\PHPStan\PhpDocParser\Printer\DiffElem::TYPE_KEEP || $diffType === \Argtyper202511\PHPStan\PhpDocParser\Printer\DiffElem::TYPE_REPLACE) {
            ...
            } elseif ($diffType === \Argtyper202511\PHPStan\PhpDocParser\Printer\DiffElem::TYPE_ADD) {
                if ($insertStr === null) {
                    return null;
                }
                ...
                $tokenIndex = $itemEndPos + 1;
            } elseif ($diffType === \Argtyper202511\PHPStan\PhpDocParser\Printer\DiffElem::TYPE_REMOVE) {
