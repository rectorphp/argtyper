...
final class CachingExecutor implements \RectorPrefix202512\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\RectorPrefix202512\React\Dns\Query\ExecutorInterface $executor, CacheInterface $cache)
    {
