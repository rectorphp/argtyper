...
final class CachingExecutor implements \RectorPrefix202511\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\RectorPrefix202511\React\Dns\Query\ExecutorInterface $executor, CacheInterface $cache)
    {
