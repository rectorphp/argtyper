...
final class FallbackExecutor implements \RectorPrefix202511\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\RectorPrefix202511\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix202511\React\Dns\Query\ExecutorInterface $fallback)
    {
