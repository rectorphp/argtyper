...
final class FallbackExecutor implements \RectorPrefix202512\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\RectorPrefix202512\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix202512\React\Dns\Query\ExecutorInterface $fallback)
    {
