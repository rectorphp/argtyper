 ...
 * ```
 */
final class CoopExecutor implements \RectorPrefix202511\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\RectorPrefix202511\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\RectorPrefix202511\React\Dns\Query\Query $query)
    {
