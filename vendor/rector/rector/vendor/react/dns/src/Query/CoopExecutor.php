 ...
 * ```
 */
final class CoopExecutor implements \RectorPrefix202512\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\RectorPrefix202512\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\RectorPrefix202512\React\Dns\Query\Query $query)
    {
