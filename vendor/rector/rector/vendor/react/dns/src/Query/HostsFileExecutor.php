...
use RectorPrefix202511\React\Dns\Model\Record;
 ...
 */
final class HostsFileExecutor implements \RectorPrefix202511\React\Dns\Query\ExecutorInterface
{
    private $hosts;
    private $fallback;
    public function __construct(HostsFile $hosts, \RectorPrefix202511\React\Dns\Query\ExecutorInterface $fallback)
    {
        $this->hosts = $hosts;
