 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix202511\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix202511\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix202511\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
