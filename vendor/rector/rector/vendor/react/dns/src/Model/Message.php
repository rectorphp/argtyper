...
namespace RectorPrefix202512\React\Dns\Model;
...
final class Message
{
    ...
    {
        $request = new \RectorPrefix202512\React\Dns\Model\Message();
    ...
    {
        $response = new \RectorPrefix202512\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \RectorPrefix202512\React\Dns\Model\Message::RCODE_OK;
    /**
