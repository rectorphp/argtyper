...
namespace Argtyper202511\RectorPrefix202511\React\Socket;

use Argtyper202511\RectorPrefix202511\React\Dns\Config\Config as DnsConfig;
use Argtyper202511\RectorPrefix202511\React\Dns\Resolver\Factory as DnsFactory;
use Argtyper202511\RectorPrefix202511\React\Dns\Resolver\ResolverInterface;
...
final class Connector implements ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        if (!isset($this->connectors[$scheme])) {
            return \Argtyper202511\RectorPrefix202511\React\Promise\reject(new \RuntimeException('No connector available for URI scheme "' . $scheme . '" (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : (\defined('PCNTL_EINVAL') ? \PCNTL_EINVAL : 22)));
        }
