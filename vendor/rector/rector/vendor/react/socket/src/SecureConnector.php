...
use Argtyper202511\RectorPrefix202511\React\Promise;
...
final class SecureConnector implements ConnectorInterface
{
    ...
    {
        if (!\function_exists('stream_socket_enable_crypto') && !\function_exists('Argtyper202511\stream_socket_enable_crypto') && !\function_exists('Argtyper202511\RectorPrefix202511\stream_socket_enable_crypto')) {
        ...
        return new \Argtyper202511\RectorPrefix202511\React\Promise\Promise(function ($resolve, $reject) use ($promise) {
