 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix202511\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix202511\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
