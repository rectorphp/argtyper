 ...
 */
class LimitingServer extends EventEmitter implements \RectorPrefix202512\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix202512\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix202512\React\Socket\ConnectionInterface $connection)
    {
