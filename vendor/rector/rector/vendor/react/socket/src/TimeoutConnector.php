...
final class TimeoutConnector implements \RectorPrefix202511\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
     ...
     */
    public function __construct(\RectorPrefix202511\React\Socket\ConnectorInterface $connector, $timeout, $loop = null)
    {
