 ...
 * @internal
 */
final class FdServer extends EventEmitter implements \RectorPrefix202511\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    private $unix = \false;
    ...
    public function __construct($fd, $loop = null)
    {
        ...
        if (\false === $this->master) {
            throw new \RuntimeException('Failed to listen on FD ' . $fd . ': ' . $errstr . \RectorPrefix202511\React\Socket\SocketServer::errconst($errno), $errno);
        }
