 ...
 */
final class SecureServer extends EventEmitter implements \RectorPrefix202512\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix202512\React\Socket\ServerInterface $tcp, $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix202512\React\Socket\StreamEncryption($loop ?: Loop::get());
    ...
    /** @internal */
    public function handleConnection(\RectorPrefix202512\React\Socket\ConnectionInterface $connection)
    {
