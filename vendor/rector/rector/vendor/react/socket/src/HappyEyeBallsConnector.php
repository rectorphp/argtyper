...
final class HappyEyeBallsConnector implements \RectorPrefix202511\React\Socket\ConnectorInterface
{
    private $loop;
    private $connector;
    private $resolver;
    ...
    public function __construct($loop = null, $connector = null, $resolver = null)
    {
        ...
        if (!$connector instanceof \RectorPrefix202511\React\Socket\ConnectorInterface) {
            // manual type check to support legacy PHP < 7.1
    ...
    public function connect($uri)
    {
        ...
        $builder = new \RectorPrefix202511\React\Socket\HappyEyeBallsConnectionBuilder($this->loop, $this->connector, $this->resolver, $uri, $host, $parts);
