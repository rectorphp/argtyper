 ...
 */
final class TcpServer extends EventEmitter implements \RectorPrefix202511\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    ...
    public function __construct($uri, $loop = null, array $context = array())
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on "' . $uri . '": ' . $errstr . \RectorPrefix202511\React\Socket\SocketServer::errconst($errno), $errno);
        }
    ...
    public function resume()
    {
        ...
        $this->loop->addReadStream($this->master, function ($master) use ($that) {
            try {
                $newSocket = \RectorPrefix202511\React\Socket\SocketServer::accept($master);
    ...
    {
        $this->emit('connection', array(new \RectorPrefix202511\React\Socket\Connection($socket, $this->loop)));
    }
}
