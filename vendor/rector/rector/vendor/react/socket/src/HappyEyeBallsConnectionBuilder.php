...
use RectorPrefix202512\React\EventLoop\TimerInterface;
...
final class HappyEyeBallsConnectionBuilder
{
    ...
    public $lastError6;
    public $lastError4;
    public function __construct(LoopInterface $loop, \RectorPrefix202512\React\Socket\ConnectorInterface $connector, ResolverInterface $resolver, $uri, $host, $parts)
    {
        $this->loop = $loop;
    ...
    {
        $uri = \RectorPrefix202512\React\Socket\Connector::uri($this->parts, $this->host, $ip);
