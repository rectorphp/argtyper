...
use RectorPrefix202512\libev\EventLoop;
use RectorPrefix202512\libev\IOEvent;
use RectorPrefix202512\libev\SignalEvent;
use RectorPrefix202512\libev\TimerEvent;
 ...
 */
final class ExtLibevLoop implements \RectorPrefix202512\React\EventLoop\LoopInterface
{
    private $loop;
