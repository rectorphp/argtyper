 ...
 */
final class ExtLibeventLoop implements \RectorPrefix202512\React\EventLoop\LoopInterface
{
    /** @internal */
    ...
    {
        if (!\function_exists('event_base_new') && !\function_exists('Argtyper202601\event_base_new') && !\function_exists('RectorPrefix202512\event_base_new')) {
            throw new BadMethodCallException('Cannot create ExtLibeventLoop, ext-libevent extension missing');
        }
        $this->eventBase = \event_base_new();
        $this->futureTickQueue = new FutureTickQueue();
        $this->timerEvents = new SplObjectStorage();
        $this->signals = new \RectorPrefix202512\React\EventLoop\SignalsHandler();
    ...
    public function cancelTimer(\RectorPrefix202512\React\EventLoop\TimerInterface $timer)
    {
     ...
     */
    private function scheduleTimer(\RectorPrefix202512\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use ($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \RectorPrefix202512\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
