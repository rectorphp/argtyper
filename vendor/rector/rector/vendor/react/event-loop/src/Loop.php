...
final class Loop
{
    ...
    {
        if (self::$instance instanceof \RectorPrefix202512\React\EventLoop\LoopInterface) {
            return self::$instance;
        }
        self::$instance = $loop = \RectorPrefix202512\React\EventLoop\Factory::create();
     ...
     * @return void
     */
    public static function set(\RectorPrefix202512\React\EventLoop\LoopInterface $loop)
    {
        self::$instance = $loop;
    }
    /**
     ...
     */
    public static function cancelTimer(\RectorPrefix202512\React\EventLoop\TimerInterface $timer)
    {
        if (self::$instance !== null) {
