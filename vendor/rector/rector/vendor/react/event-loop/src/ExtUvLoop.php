 ...
 */
final class ExtUvLoop implements \RectorPrefix202511\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    {
        if (!\function_exists('uv_loop_new') && !\function_exists('Argtyper202511\uv_loop_new') && !\function_exists('RectorPrefix202511\uv_loop_new')) {
