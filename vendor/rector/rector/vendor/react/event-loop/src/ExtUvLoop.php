 ...
 */
final class ExtUvLoop implements \RectorPrefix202512\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    {
        if (!\function_exists('uv_loop_new') && !\function_exists('Argtyper202601\uv_loop_new') && !\function_exists('RectorPrefix202512\uv_loop_new')) {
