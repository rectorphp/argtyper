...
final class Util
{
     ...
     */
    public static function pipe(\RectorPrefix202511\React\Stream\ReadableStreamInterface $source, \RectorPrefix202511\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
