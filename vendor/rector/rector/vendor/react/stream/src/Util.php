...
final class Util
{
     ...
     */
    public static function pipe(\RectorPrefix202512\React\Stream\ReadableStreamInterface $source, \RectorPrefix202512\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
