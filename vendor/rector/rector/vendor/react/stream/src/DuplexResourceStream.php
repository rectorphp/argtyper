...
final class DuplexResourceStream extends EventEmitter implements \RectorPrefix202511\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, $loop = null, $readChunkSize = null, $buffer = null)
    {
        ...
        if ($buffer !== null && !$buffer instanceof \RectorPrefix202511\React\Stream\WritableResourceStream && \stream_set_blocking($stream, \false) !== \true) {
        ...
        if ($buffer !== null && !$buffer instanceof \RectorPrefix202511\React\Stream\WritableStreamInterface) {
            // manual type check to support legacy PHP < 7.1
        ...
        if ($buffer === null) {
            $buffer = new \RectorPrefix202511\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
