...
use function RectorPrefix202511\React\Promise\_checkTypehint;
use function RectorPrefix202511\React\Promise\resolve;
use function RectorPrefix202511\React\Promise\set_rejection_handler;
/**
 * @internal
 *
...
final class RejectedPromise implements PromiseInterface
{
    ...
    public function then(?callable $onFulfilled = null, ?callable $onRejected = null): PromiseInterface
    {
        ...
        try {
            ...
            return new \RectorPrefix202511\React\Promise\Internal\RejectedPromise($exception);
        }
    }
    /**
    ...
    public function finally(callable $onFulfilledOrRejected): PromiseInterface
    {
        return $this->then(null, function (\Throwable $reason) use ($onFulfilledOrRejected): PromiseInterface {
            return resolve($onFulfilledOrRejected())->then(function () use ($reason): PromiseInterface {
                return new \RectorPrefix202511\React\Promise\Internal\RejectedPromise($reason);
            });
        });
    }
