 ...
 */
final class Promise implements \RectorPrefix202511\React\Promise\PromiseInterface
{
    ...
    public function then(?callable $onFulfilled = null, ?callable $onRejected = null): \RectorPrefix202511\React\Promise\PromiseInterface
    {
        if (null !== $this->result) {
     ...
     */
    public function catch(callable $onRejected): \RectorPrefix202511\React\Promise\PromiseInterface
    {
    ...
    public function finally(callable $onFulfilledOrRejected): \RectorPrefix202511\React\Promise\PromiseInterface
    {
        return $this->then(static function ($value) use ($onFulfilledOrRejected): \RectorPrefix202511\React\Promise\PromiseInterface {
            /** @var T $value */
            return resolve($onFulfilledOrRejected())->then(function () use ($value) {
                return $value;
            });
        }, static function (\Throwable $reason) use ($onFulfilledOrRejected): \RectorPrefix202511\React\Promise\PromiseInterface {
     ...
     * @see self::catch()
     */
    public function otherwise(callable $onRejected): \RectorPrefix202511\React\Promise\PromiseInterface
    {
     ...
     * @see self::finally()
     */
    public function always(callable $onFulfilledOrRejected): \RectorPrefix202511\React\Promise\PromiseInterface
    {
    ...
    private function resolver(?callable $onFulfilled = null, ?callable $onRejected = null): callable
    {
        return function (callable $resolve, callable $reject) use ($onFulfilled, $onRejected): void {
            $this->handlers[] = static function (\RectorPrefix202511\React\Promise\PromiseInterface $promise) use ($onFulfilled, $onRejected, $resolve, $reject): void {
                $promise = $promise->then($onFulfilled, $onRejected);
                if ($promise instanceof self && $promise->result === null) {
                    $promise->handlers[] = static function (\RectorPrefix202511\React\Promise\PromiseInterface $promise) use ($resolve, $reject): void {
     ...
     */
    private function settle(\RectorPrefix202511\React\Promise\PromiseInterface $result): void
    {
     ...
     */
    private function unwrap(\RectorPrefix202511\React\Promise\PromiseInterface $promise): \RectorPrefix202511\React\Promise\PromiseInterface
    {
