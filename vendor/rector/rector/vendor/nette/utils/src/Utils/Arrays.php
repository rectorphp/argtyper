...
class Arrays
{
    ...
    {
        return \RectorPrefix202511\Nette\Utils\Helpers::falseToNull(array_search(self::toKey($key), array_keys($array), \true));
    }
    /**
    ...
    ): array
    {
        ...
        return \RectorPrefix202511\Nette\Utils\Strings::pcre('preg_grep', [$pattern, $array, $flags]);
    }
    /**
