...
final class Reflection
{
    ...
    {
        return \RectorPrefix202511\Nette\Utils\Validators::isBuiltinType($type);
    }
    /** @deprecated use Nette\Utils\Validators::isClassKeyword() */
    public static function isClassKeyword(string $name): bool
    {
        return \RectorPrefix202511\Nette\Utils\Validators::isClassKeyword($name);
    }
    /**
     * @return mixed
     */
    public static function getParameterDefaultValue(\ReflectionParameter $param)
    {
        if ($param->isDefaultValueConstant()) {
            ...
            $pair = explode('::', $const);
            if (isset($pair[1])) {
                $pair[0] = \RectorPrefix202511\Nette\Utils\Type::resolve($pair[0], $param);
                try {
    ...
    public static function expandClassName(string $name, \ReflectionClass $context): string
    {
        ...
        } elseif (\RectorPrefix202511\Nette\Utils\Validators::isBuiltinType($lower)) {
            return $lower;
