...
final class DependsAnnotationWithValueToAttributeRector extends AbstractRector implements MinPhpVersionInterface
{
     ...
     * @var string
     */
    private const DEPENDS_ATTRIBUTE = 'Argtyper202601\PHPUnit\Framework\Attributes\Depends';
...
CODE_SAMPLE
    ...
    private function resolveAttributeValueAndAttributeName(Class_ $currentClass, string $currentMethodName, string $originalAttributeValue): ?array
    {
        ...
        if (!is_string($attributeValue)) {
            ...
            $attributeName = 'Argtyper202601\PHPUnit\Framework\Attributes\DependsOnClass';
        }
        if (!is_string($attributeValue)) {
            ...
            $attributeName = 'Argtyper202601\PHPUnit\Framework\Attributes\DependsUsingDeepClone';
        }
        if (!is_string($attributeValue)) {
            return null;
        }
