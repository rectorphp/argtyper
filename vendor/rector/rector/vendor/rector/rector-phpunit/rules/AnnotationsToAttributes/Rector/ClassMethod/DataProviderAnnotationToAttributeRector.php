...
final class DataProviderAnnotationToAttributeRector extends AbstractRector implements MinPhpVersionInterface
{
     ...
     * @var string
     */
    private const DATA_PROVIDER_CLASS = 'Argtyper202511\PHPUnit\Framework\Attributes\DataProvider';
...
CODE_SAMPLE
    ...
    private function createAttributeGroup(string $originalAttributeValue): AttributeGroup
    {
        ...
        if ($className !== '') {
            ...
            return $this->phpAttributeGroupFactory->createFromClassWithItems('Argtyper202511\PHPUnit\Framework\Attributes\DataProviderExternal', [$className . '::class', $methodName]);
        }
