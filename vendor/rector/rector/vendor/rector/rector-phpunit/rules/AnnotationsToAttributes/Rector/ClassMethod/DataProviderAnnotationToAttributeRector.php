...
final class DataProviderAnnotationToAttributeRector extends AbstractRector implements MinPhpVersionInterface
{
     ...
     * @var string
     */
    private const DATA_PROVIDER_CLASS = 'Argtyper202601\PHPUnit\Framework\Attributes\DataProvider';
...
CODE_SAMPLE
    ...
    private function createAttributeGroup(ClassMethod $classMethod, string $originalAttributeValue): ?AttributeGroup
    {
        ...
        if ($className !== '') {
            ...
            $attributeGroup = $this->phpAttributeGroupFactory->createFromClassWithItems('Argtyper202601\PHPUnit\Framework\Attributes\DataProviderExternal', [$className . '::class', $methodName]);
        } else {
