...
use Argtyper202511\Rector\PHPUnit\CodeQuality\NodeAnalyser\ClosureUsesResolver;
use Argtyper202511\Rector\PHPUnit\CodeQuality\NodeFactory\FromBinaryAndAssertExpressionsFactory;
use Argtyper202511\Rector\PHPUnit\CodeQuality\ValueObject\ArgAndFunctionLike;
...
final class WithCallbackIdenticalToStandaloneAssertsRector extends AbstractRector
{
    /**
     * @readonly
     * @var \Rector\PHPUnit\CodeQuality\NodeAnalyser\ClosureUsesResolver
     */
    private $closureUsesResolver;
    /**
     * @readonly
    ...
    /**
     * @readonly
     * @var \Rector\PHPUnit\CodeQuality\NodeFactory\FromBinaryAndAssertExpressionsFactory
     */
    private $fromBinaryAndAssertExpressionsFactory;
