...
use Argtyper202511\RectorPrefix202511\PHPUnit\Framework\MockObject\Builder\InvocationMocker;
use Argtyper202511\Rector\Enum\ClassName;
use Argtyper202511\Rector\PHPStanStaticTypeMapper\Enum\TypeKind;
use Argtyper202511\Rector\PHPUnit\CodeQuality\NodeAnalyser\SetUpAssignedMockTypesResolver;
use Argtyper202511\Rector\PHPUnit\CodeQuality\Reflection\MethodParametersAndReturnTypesResolver;
use Argtyper202511\Rector\PHPUnit\CodeQuality\ValueObject\ParamTypesAndReturnType;
...
final class TypeWillReturnCallableArrowFunctionRector extends AbstractRector
{
    ...
    /**
     * @readonly
     * @var \Rector\PHPUnit\CodeQuality\NodeAnalyser\SetUpAssignedMockTypesResolver
     */
    private $setUpAssignedMockTypesResolver;
    /**
     * @readonly
