...
final class AddInstanceofAssertForNullableArgumentRector extends AbstractRector
{
    ...
    /**
     * @readonly
     * @var \Rector\PHPUnit\CodeQuality\NodeFactory\AssertMethodCallFactory
     */
    private $assertMethodCallFactory;
    /**
     * @readonly
     * @var \Rector\PHPUnit\CodeQuality\TypeAnalyzer\MethodCallParameterTypeResolver
     */
    private $methodCallParameterTypeResolver;
    /**
     * @readonly
