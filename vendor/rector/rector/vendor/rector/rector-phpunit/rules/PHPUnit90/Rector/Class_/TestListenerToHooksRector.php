...
namespace Argtyper202511\Rector\PHPUnit\PHPUnit90\Rector\Class_;
...
final class TestListenerToHooksRector extends AbstractRector
{
    ...
    private const LISTENER_METHOD_TO_HOOK_INTERFACES = [
        'addIncompleteTest' => ['Argtyper202511\PHPUnit\Runner\AfterIncompleteTestHook', 'executeAfterIncompleteTest'],
        'addRiskyTest' => ['Argtyper202511\PHPUnit\Runner\AfterRiskyTestHook', 'executeAfterRiskyTest'],
        'addSkippedTest' => ['Argtyper202511\PHPUnit\Runner\AfterSkippedTestHook', 'executeAfterSkippedTest'],
        'addError' => ['Argtyper202511\PHPUnit\Runner\AfterTestErrorHook', 'executeAfterTestError'],
        'addFailure' => ['Argtyper202511\PHPUnit\Runner\AfterTestFailureHook', 'executeAfterTestFailure'],
        'addWarning' => ['Argtyper202511\PHPUnit\Runner\AfterTestWarningHook', 'executeAfterTestWarning'],
        # test
        'startTest' => ['Argtyper202511\PHPUnit\Runner\BeforeTestHook', 'executeBeforeTest'],
        'endTest' => ['Argtyper202511\PHPUnit\Runner\AfterTestHook', 'executeAfterTest'],
        # suite
        'startTestSuite' => ['Argtyper202511\PHPUnit\Runner\BeforeFirstTestHook', 'executeBeforeFirstTest'],
        'endTestSuite' => ['Argtyper202511\PHPUnit\Runner\AfterLastTestHook', 'executeAfterLastTest'],
    ];
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, new ObjectType('Argtyper202511\PHPUnit\Framework\TestListener'))) {
            return null;
        }
        foreach ($node->implements as $key => $implement) {
            if (!$this->isName($implement, 'Argtyper202511\PHPUnit\Framework\TestListener')) {
                continue;
            }
