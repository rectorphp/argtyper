...
namespace Argtyper202511\Rector\PHPUnit\PHPUnit60\Rector\MethodCall;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isObjectType($currentMethodCall->var, new ObjectType('Argtyper202511\\PHPUnit\\Framework\\TestCase'))) {
            return null;
        }
