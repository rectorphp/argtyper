...
namespace Argtyper202511\Rector\PHPUnit\PHPUnit60\Rector\ClassMethod;
...
use Argtyper202511\Rector\PHPUnit\NodeAnalyzer\AssertCallAnalyzer;
use Argtyper202511\Rector\PHPUnit\NodeAnalyzer\MockedVariableAnalyzer;
...
CODE_SAMPLE
    ...
    private function hasAssertingAnnotationOrAttribute(ClassMethod $classMethod) : bool
    {
        ...
        return $this->phpAttributeAnalyzer->hasPhpAttribute($classMethod, 'Argtyper202511\\PHPUnit\\Framework\\Attributes\\DoesNotPerformAssertions');
    }
}
