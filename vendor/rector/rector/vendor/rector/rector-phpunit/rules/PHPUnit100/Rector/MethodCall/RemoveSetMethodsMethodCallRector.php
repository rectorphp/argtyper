...
namespace Argtyper202511\Rector\PHPUnit\PHPUnit100\Rector\MethodCall;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isObjectType($node->var, new ObjectType('Argtyper202511\\PHPUnit\\Framework\\MockObject\\MockBuilder'))) {
            return null;
        }
