...
CODE_SAMPLE
    ...
    private function resolveParentNativeReturnType(ClassMethod $classMethod): ?Node
    {
        ...
        $parents = array_merge(is_array($classReflection->getParents()) ? $classReflection->getParents() : iterator_to_array((is_array(is_array($classReflection->getParents()) ? new \ArrayIterator($classReflection->getParents()) : $classReflection->getParents()) ? new \ArrayIterator(is_array($classReflection->getParents()) ? new \ArrayIterator($classReflection->getParents()) : $classReflection->getParents()) : is_array($classReflection->getParents())) ? new \ArrayIterator($classReflection->getParents()) : $classReflection->getParents()), is_array($classReflection->getInterfaces()) ? $classReflection->getInterfaces() : iterator_to_array((is_array(is_array($classReflection->getInterfaces()) ? new \ArrayIterator($classReflection->getInterfaces()) : $classReflection->getInterfaces()) ? new \ArrayIterator(is_array($classReflection->getInterfaces()) ? new \ArrayIterator($classReflection->getInterfaces()) : $classReflection->getInterfaces()) : is_array($classReflection->getInterfaces())) ? new \ArrayIterator($classReflection->getInterfaces()) : $classReflection->getInterfaces()));
