...
namespace Argtyper202511\Rector\RectorInstaller;
...
final class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    public function process(Event $event): void
    {
        ...
        $pluginInstaller = new \Argtyper202511\Rector\RectorInstaller\PluginInstaller(new \Argtyper202511\Rector\RectorInstaller\LocalFilesystem(), $localRepository, $io, $installationManager, new \Argtyper202511\Composer\Util\Filesystem(), $configurationFile);
