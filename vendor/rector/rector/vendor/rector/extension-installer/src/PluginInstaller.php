...
use Argtyper202511\RectorPrefix202511\Composer\Installer\InstallationManager;
use Argtyper202511\RectorPrefix202511\Composer\IO\IOInterface;
use Argtyper202511\RectorPrefix202511\Composer\Package\PackageInterface;
use Argtyper202511\RectorPrefix202511\Composer\Repository\InstalledRepositoryInterface;
use Argtyper202511\RectorPrefix202511\Composer\Util\Filesystem as ComposerFilesystem;
/**
...
final class PluginInstaller
{
    ...
    private $filesystem;
    /**
     * @var \RectorPrefix202511\Composer\Repository\InstalledRepositoryInterface
     */
    private $localRepository;
    /**
     * @var \RectorPrefix202511\Composer\IO\IOInterface
     */
    private $io;
    /**
     * @var \RectorPrefix202511\Composer\Installer\InstallationManager
     */
...
CODE_SAMPLE;
    public function __construct(\Argtyper202511\Rector\RectorInstaller\Filesystem $filesystem, InstalledRepositoryInterface $localRepository, IOInterface $io, InstallationManager $installationManager, ComposerFilesystem $composerFilesystem, string $configurationFile)
    {
