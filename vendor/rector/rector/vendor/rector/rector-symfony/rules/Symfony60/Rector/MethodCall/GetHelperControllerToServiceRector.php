...
CODE_SAMPLE
    ...
    {
        $propertyName = $this->propertyNaming->fqnToVariableName('Argtyper202601\Symfony\Component\Messenger\MessageBusInterface');
        // add dependency
        $propertyObjectType = new ObjectType('Argtyper202601\Symfony\Component\Messenger\MessageBusInterface');
    ...
    {
        $propertyName = $this->propertyNaming->fqnToVariableName('Argtyper202601\Doctrine\Persistence\ManagerRegistry');
        // add dependency
        $propertyObjectType = new ObjectType('Argtyper202601\Doctrine\Persistence\ManagerRegistry');
        return new PropertyMetadata($propertyName, $propertyObjectType);
    }
}
