...
namespace Argtyper202511\Rector\Symfony\Symfony60\Rector\MethodCall;
...
CODE_SAMPLE
    ...
    {
        $propertyName = $this->propertyNaming->fqnToVariableName('Argtyper202511\Symfony\Component\Messenger\MessageBusInterface');
        // add dependency
        $propertyObjectType = new ObjectType('Argtyper202511\Symfony\Component\Messenger\MessageBusInterface');
    ...
    {
        $propertyName = $this->propertyNaming->fqnToVariableName('Argtyper202511\Doctrine\Persistence\ManagerRegistry');
        // add dependency
        $propertyObjectType = new ObjectType('Argtyper202511\Doctrine\Persistence\ManagerRegistry');
        return new PropertyMetadata($propertyName, $propertyObjectType);
    }
}
