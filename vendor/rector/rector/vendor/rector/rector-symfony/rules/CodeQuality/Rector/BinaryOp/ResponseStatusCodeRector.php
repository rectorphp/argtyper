...
namespace Argtyper202511\Rector\Symfony\CodeQuality\Rector\BinaryOp;
...
use Argtyper202511\Rector\Symfony\ValueObject\ConstantMap\SymfonyResponseConstantMap;
...
CODE_SAMPLE
    ...
    private function processMethodCall(MethodCall $methodCall): ?\Argtyper202511\PhpParser\Node\Expr\CallLike
    {
    ...
    private function processAssertMethodCall(MethodCall $methodCall): ?\Argtyper202511\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function processRedirectMethodCall(MethodCall $methodCall): ?\Argtyper202511\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function processNew(New_ $new): ?\Argtyper202511\PhpParser\Node\Expr\New_
    {
