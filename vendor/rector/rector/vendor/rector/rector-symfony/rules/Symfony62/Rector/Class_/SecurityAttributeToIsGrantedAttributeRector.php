...
namespace Argtyper202511\Rector\Symfony\Symfony62\Rector\Class_;
...
use Argtyper202511\Rector\Symfony\CodeQuality\NodeAnalyzer\AttributePresenceDetector;
use Argtyper202511\Rector\Symfony\Enum\SensioAttribute;
...
final class SecurityAttributeToIsGrantedAttributeRector extends AbstractRector implements MinPhpVersionInterface
{
    ...
    /**
     * @readonly
     * @var \Rector\Symfony\CodeQuality\NodeAnalyzer\AttributePresenceDetector
     */
    private $attributePresenceDetector;
    /**
     * @var string
...
CODE_SAMPLE
    ...
    private function wrapToNewExpression(Expr $expr)
    {
        ...
        $args = [new Arg($expr)];
        return new New_(new FullyQualified('Argtyper202511\Symfony\Component\ExpressionLanguage\Expression'), $args);
    }
