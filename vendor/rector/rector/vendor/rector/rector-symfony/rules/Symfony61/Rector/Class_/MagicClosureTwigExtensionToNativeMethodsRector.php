...
namespace Argtyper202511\Rector\Symfony\Symfony61\Rector\Class_;
...
CODE_SAMPLE
    ...
    {
        if (!$this->nodeTypeResolver->isObjectTypes($node, [new ObjectType('Twig_ExtensionInterface'), new ObjectType('Argtyper202511\Twig\Extension\ExtensionInterface')])) {
            return null;
        }
