...
namespace Argtyper202511\Rector\Symfony\Symfony43\Rector\MethodCall;
...
use Argtyper202511\Rector\Symfony\ValueObject\IntlBundleClassToNewClass;
...
final class GetCurrencyBundleMethodCallsToIntlRector extends AbstractRector
{
    ...
    {
        $this->intlBundleClassesToNewClasses[] = new IntlBundleClassToNewClass('Argtyper202511\Symfony\Component\Intl\ResourceBundle\LanguageBundleInterface', 'Argtyper202511\Symfony\Component\Intl\Languages', ['getLanguageNames' => 'getNames', 'getLanguageName' => 'getName']);
        $this->intlBundleClassesToNewClasses[] = new IntlBundleClassToNewClass('Argtyper202511\Symfony\Component\Intl\ResourceBundle\RegionBundleInterface', 'Argtyper202511\Symfony\Component\Intl\Currencies', ['getCountryNames' => 'getNames', 'getCountryName' => 'getName']);
        $this->intlBundleClassesToNewClasses[] = new IntlBundleClassToNewClass('Argtyper202511\Symfony\Component\Intl\ResourceBundle\CurrencyBundleInterface', 'Argtyper202511\Symfony\Component\Intl\Currencies', ['getCurrencyNames' => 'getNames', 'getCurrencyName' => 'getName', 'getCurrencySymbol' => 'getSymbol', 'getFractionDigits' => 'getFractionDigits']);
    }
