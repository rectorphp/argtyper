...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isObjectType($node->var, new ObjectType('Argtyper202511\\Symfony\\Component\\Validator\\ValidatorBuilder'))) {
            return null;
        }
        ...
        if (!$this->isObjectType($firstArg->value, new ObjectType('Argtyper202511\\Doctrine\\Common\\Annotations\\Reader'))) {
            return null;
        }
