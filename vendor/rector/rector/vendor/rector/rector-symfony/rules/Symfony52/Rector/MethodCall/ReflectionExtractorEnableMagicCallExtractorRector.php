...
namespace Argtyper202511\Rector\Symfony\Symfony52\Rector\MethodCall;
...
CODE_SAMPLE
    ...
    private function shouldSkip(MethodCall $methodCall) : bool
    {
        ...
        $reflectionExtractorObjectType = new ObjectType('Argtyper202511\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor');
    ...
    {
        $magicGetClassConstFetch = $this->nodeFactory->createClassConstFetch('Argtyper202511\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_GET');
        $magicSetClassConstFetch = $this->nodeFactory->createClassConstFetch('Argtyper202511\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_SET');
        if (!$enableMagicCallExtractionValue) {
            return new BitwiseOr($magicGetClassConstFetch, $magicSetClassConstFetch);
        }
        $magicCallClassConstFetch = $this->nodeFactory->createClassConstFetch('Argtyper202511\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_CALL');
