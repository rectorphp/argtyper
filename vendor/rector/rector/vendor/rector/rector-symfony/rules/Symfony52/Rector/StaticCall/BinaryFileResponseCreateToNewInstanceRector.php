...
namespace Argtyper202511\Rector\Symfony\Symfony52\Rector\StaticCall;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isName($node->class, 'Argtyper202511\\Symfony\\Component\\HttpFoundation\\BinaryFileResponse')) {
            return null;
        }
