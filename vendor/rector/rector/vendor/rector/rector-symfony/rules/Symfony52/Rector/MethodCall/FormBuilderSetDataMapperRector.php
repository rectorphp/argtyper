...
final class FormBuilderSetDataMapperRector extends AbstractRector
{
     ...
     * @var string
     */
    private const DATAMAPPER_INTERFACE = 'Argtyper202511\\Symfony\\Component\\Form\\DataMapperInterface';
    /**
     * @var string
     */
    private const DATAMAPPER_CLASS = 'Argtyper202511\\Symfony\\Component\\Form\\Extension\\Core\\DataMapper\\DataMapper';
    /**
     * @readonly
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isObjectType($node->var, new ObjectType('Argtyper202511\\Symfony\\Component\\Form\\FormConfigBuilderInterface'))) {
            return null;
        }
        $args = $node->getArgs();
        $firstArg = $args[0];
        ...
        $new = new New_(new FullyQualified('Argtyper202511\\Symfony\\Component\\Form\\Extension\\Core\\DataAccessor\\PropertyPathAccessor'));
