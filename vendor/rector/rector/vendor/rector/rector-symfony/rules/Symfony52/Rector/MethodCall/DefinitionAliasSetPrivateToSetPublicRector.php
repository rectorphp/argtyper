...
final class DefinitionAliasSetPrivateToSetPublicRector extends AbstractRector
{
    ...
    public function __construct(ValueResolver $valueResolver)
    {
        ...
        $this->definitionObjectTypes = [new ObjectType('Argtyper202511\Symfony\Component\DependencyInjection\Alias'), new ObjectType('Argtyper202511\Symfony\Component\DependencyInjection\Definition')];
    }
