...
CODE_SAMPLE
    ...
    private function shouldSkip(New_ $new): bool
    {
        ...
        return !$this->isName($new->class, 'Argtyper202601\Symfony\Component\Form\Extension\Core\DataMapper\PropertyPathMapper');
    }
    private function generateNewInstances(New_ $new): New_
    {
        ...
        $new = new New_(new FullyQualified('Argtyper202601\Symfony\Component\Form\Extension\Core\DataAccessor\PropertyPathAccessor'), $arguments);
        return new New_(new FullyQualified('Argtyper202601\Symfony\Component\Form\Extension\Core\DataMapper\DataMapper'), [$this->nodeFactory->createArg($new)]);
    }
}
