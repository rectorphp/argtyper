...
namespace Argtyper202511\Rector\Symfony\Symfony34\Rector\Closure;
...
use Argtyper202511\Rector\Symfony\NodeAnalyzer\ServiceTypeMethodCallResolver;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isObjectType($node->var, new ObjectType('Argtyper202511\\Symfony\\Component\\DependencyInjection\\ContainerInterface'))) {
            return null;
        }
