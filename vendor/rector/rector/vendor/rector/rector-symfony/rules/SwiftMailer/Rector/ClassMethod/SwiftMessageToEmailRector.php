...
namespace Argtyper202511\Rector\Symfony\SwiftMailer\Rector\ClassMethod;
...
final class SwiftMessageToEmailRector extends AbstractRector
{
     ...
     * @var string
     */
    private const EMAIL_FQN = 'Argtyper202511\\Symfony\\Component\\Mime\\Email';
    /**
     * @var string
     */
...
CODE_SAMPLE
    ...
    {
        return new New_(new FullyQualified('Argtyper202511\\Symfony\\Component\\Mime\\Address'), $addressArguments);
    }
}
