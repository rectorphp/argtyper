...
namespace Argtyper202511\Rector\Symfony\Symfony28\Rector\StaticCall;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->isObjectType($node->class, new ObjectType('Argtyper202511\\Symfony\\Component\\Yaml\\Yaml'))) {
            return null;
        }
