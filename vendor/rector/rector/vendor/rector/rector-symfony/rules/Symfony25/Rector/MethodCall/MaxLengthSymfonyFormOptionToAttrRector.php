...
CODE_SAMPLE
    ...
    private function isFormCreateMethodCallMatch(MethodCall $methodCall): bool
    {
        ...
        return $this->isObjectType($methodCall->var, new ObjectType('Argtyper202511\Symfony\Component\Form\FormFactoryInterface')) || $this->isObjectType($methodCall->var, new ObjectType('Argtyper202511\Symfony\Component\Form\FormBuilderInterface'));
    }
}
