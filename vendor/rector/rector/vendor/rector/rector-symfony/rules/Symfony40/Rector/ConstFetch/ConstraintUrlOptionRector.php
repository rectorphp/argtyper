...
final class ConstraintUrlOptionRector extends AbstractRector
{
     ...
     * @var string
     */
    private const URL_CONSTRAINT_CLASS = 'Argtyper202601\Symfony\Component\Validator\Constraints\Url';
    ...
    {
        if (!$this->isObjectType($node, new ObjectType('Argtyper202601\Symfony\Component\Validator\Constraints\Url'))) {
            return null;
        }
