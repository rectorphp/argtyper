...
namespace Argtyper202511\Rector\Symfony\Symfony51\Rector\Class_;
...
use Argtyper202511\Rector\Symfony\NodeAnalyzer\ClassAnalyzer;
use Argtyper202511\Rector\Symfony\NodeFactory\GetSubscribedEventsClassMethodFactory;
use Argtyper202511\Rector\Symfony\NodeFactory\OnLogoutClassMethodFactory;
use Argtyper202511\Rector\Symfony\ValueObject\EventReferenceToMethodName;
...
final class LogoutHandlerToLogoutEventSubscriberRector extends AbstractRector
{
    ...
    public function __construct(OnLogoutClassMethodFactory $onLogoutClassMethodFactory, GetSubscribedEventsClassMethodFactory $getSubscribedEventsClassMethodFactory, ClassAnalyzer $classAnalyzer)
    {
        ...
        $this->logoutHandlerObjectType = new ObjectType('Argtyper202511\Symfony\Component\Security\Http\Logout\LogoutHandlerInterface');
    }
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if (!$this->classAnalyzer->hasImplements($node, 'Argtyper202511\Symfony\Component\Security\Http\Logout\LogoutHandlerInterface')) {
            return null;
        }
        ...
        $node->implements[] = new FullyQualified('Argtyper202511\Symfony\Component\EventDispatcher\EventSubscriberInterface');
        ...
        $classConstFetch = $this->nodeFactory->createClassConstReference('Argtyper202511\Symfony\Component\Security\Http\Event\LogoutEvent');
