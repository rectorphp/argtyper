...
use Argtyper202511\Rector\Symfony\Symfony73\NodeAnalyzer\CommandArgumentsResolver;
use Argtyper202511\Rector\Symfony\Symfony73\NodeAnalyzer\CommandOptionsResolver;
use Argtyper202511\Rector\Symfony\Symfony73\NodeFactory\CommandInvokeParamsFactory;
use Argtyper202511\Rector\Symfony\Symfony73\NodeTransformer\CommandUnusedInputOutputRemover;
use Argtyper202511\Rector\Symfony\Symfony73\NodeTransformer\ConsoleOptionAndArgumentMethodCallVariableReplacer;
use Argtyper202511\Rector\Symfony\Symfony73\NodeTransformer\OutputInputSymfonyStyleReplacer;
...
final class InvokableCommandInputAttributeRector extends AbstractRector
{
    ...
    /**
     * @readonly
     * @var \Rector\Symfony\Symfony73\NodeAnalyzer\CommandArgumentsResolver
     */
    private $commandArgumentsResolver;
    /**
     * @readonly
     * @var \Rector\Symfony\Symfony73\NodeAnalyzer\CommandOptionsResolver
     */
    private $commandOptionsResolver;
    /**
     * @readonly
     * @var \Rector\Symfony\Symfony73\NodeFactory\CommandInvokeParamsFactory
     */
    private $commandInvokeParamsFactory;
    /**
     * @readonly
     * @var \Rector\Symfony\Symfony73\NodeTransformer\ConsoleOptionAndArgumentMethodCallVariableReplacer
     */
    private $consoleOptionAndArgumentMethodCallVariableReplacer;
    /**
     * @readonly
    ...
    /**
     * @readonly
     * @var \Rector\Symfony\Symfony73\NodeTransformer\OutputInputSymfonyStyleReplacer
     */
    private $outputInputSymfonyStyleReplacer;
    /**
     * @readonly
     * @var \Rector\Symfony\Symfony73\NodeTransformer\CommandUnusedInputOutputRemover
     */
    private $commandUnusedInputOutputRemover;
