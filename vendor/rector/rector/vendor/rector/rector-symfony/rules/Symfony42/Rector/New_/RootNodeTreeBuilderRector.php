...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        foreach ($node->stmts as $stmt) {
            ...
            if (!$this->isObjectType($new->class, new ObjectType('Argtyper202601\Symfony\Component\Config\Definition\Builder\TreeBuilder'))) {
                continue;
            }
    ...
    private function getRootMethodCallNode(StmtsAwareInterface $stmtsAware): ?Node
    {
        ...
        foreach ($methodCalls as $methodCall) {
            ...
            if (!$this->isObjectType($methodCall->var, new ObjectType('Argtyper202601\Symfony\Component\Config\Definition\Builder\TreeBuilder'))) {
                continue;
            }
