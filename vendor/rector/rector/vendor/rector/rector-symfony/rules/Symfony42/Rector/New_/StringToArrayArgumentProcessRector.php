...
namespace Argtyper202511\Rector\Symfony\Symfony42\Rector\New_;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if ($this->isObjectType($expr, new ObjectType('Argtyper202511\Symfony\Component\Process\Process'))) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, new ObjectType('Argtyper202511\Symfony\Component\Console\Helper\ProcessHelper'))) {
