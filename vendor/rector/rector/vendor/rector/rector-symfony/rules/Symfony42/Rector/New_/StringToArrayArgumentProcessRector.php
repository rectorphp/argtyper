...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if ($this->isObjectType($expr, new ObjectType('Argtyper202601\Symfony\Component\Process\Process'))) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, new ObjectType('Argtyper202601\Symfony\Component\Console\Helper\ProcessHelper'))) {
