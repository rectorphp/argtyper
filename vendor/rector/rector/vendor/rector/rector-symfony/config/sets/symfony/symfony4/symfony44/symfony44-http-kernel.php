...
return static function (RectorConfig $rectorConfig): void {
    $rectorConfig->ruleWithConfiguration(RenameMethodRector::class, [
        ...
        new MethodCallRename('Argtyper202511\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent', 'getException', 'getThrowable'),
        ...
        new MethodCallRename('Argtyper202511\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent', 'setException', 'setThrowable'),
    ]);
};
