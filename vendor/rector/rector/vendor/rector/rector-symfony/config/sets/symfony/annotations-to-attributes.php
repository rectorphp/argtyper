...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(AnnotationToAttributeRector::class, [
        ...
        new AnnotationToAttribute('required', 'Argtyper202601\Symfony\Contracts\Service\Attribute\Required'),
        new AnnotationToAttribute('Argtyper202601\Symfony\Component\Routing\Annotation\Route'),
        ...
        new AnnotationToAttribute('Argtyper202601\Symfony\Bridge\Doctrine\Validator\Constraints\UniqueEntity'),
    ]);
};
