...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(AnnotationToAttributeRector::class, [
        ...
        new AnnotationToAttribute('required', 'Argtyper202511\Symfony\Contracts\Service\Attribute\Required'),
        ...
        new AnnotationToAttribute('Argtyper202511\Symfony\Bridge\Doctrine\Validator\Constraints\UniqueEntity'),
    ]);
};
