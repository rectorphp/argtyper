...
namespace Argtyper202511\Rector\Symfony\Bridge\Symfony;
...
use Argtyper202511\RectorPrefix202511\Symfony\Component\DependencyInjection\Container;
...
final class ContainerServiceProvider
{
    ...
    private function getSymfonyContainer(): object
    {
        if ($this->container === null) {
            ...
            Assert::isInstanceOf($container, 'Argtyper202511\Symfony\Component\DependencyInjection\Container');
