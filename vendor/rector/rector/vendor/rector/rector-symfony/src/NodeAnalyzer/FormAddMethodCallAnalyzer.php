...
final class FormAddMethodCallAnalyzer
{
    ...
    public function __construct(NodeTypeResolver $nodeTypeResolver, NodeNameResolver $nodeNameResolver)
    {
        ...
        $this->formObjectTypes = [new ObjectType('Argtyper202601\Symfony\Component\Form\FormBuilderInterface'), new ObjectType('Argtyper202601\Symfony\Component\Form\FormInterface')];
    }
