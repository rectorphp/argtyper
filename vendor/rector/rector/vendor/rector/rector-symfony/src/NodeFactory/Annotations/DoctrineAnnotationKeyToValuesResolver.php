...
final class DoctrineAnnotationKeyToValuesResolver
{
    ...
    public function __construct(ValueResolver $valueResolver, \Argtyper202511\Rector\Symfony\NodeFactory\Annotations\StringValueQuoteWrapper $stringValueQuoteWrapper)
    {
