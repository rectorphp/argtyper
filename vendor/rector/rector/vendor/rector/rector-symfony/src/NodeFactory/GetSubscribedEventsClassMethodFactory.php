...
use Argtyper202511\Rector\Symfony\ValueObject\Tag;
use Argtyper202511\Rector\Symfony\ValueObject\Tag\EventListenerTag;
...
final class GetSubscribedEventsClassMethodFactory
{
    ...
    public function __construct(NodeFactory $nodeFactory, VisibilityManipulator $visibilityManipulator, PhpVersionProvider $phpVersionProvider, PhpDocInfoFactory $phpDocInfoFactory, PhpDocTypeChanger $phpDocTypeChanger, \Argtyper202511\Rector\Symfony\NodeFactory\EventReferenceFactory $eventReferenceFactory)
    {
