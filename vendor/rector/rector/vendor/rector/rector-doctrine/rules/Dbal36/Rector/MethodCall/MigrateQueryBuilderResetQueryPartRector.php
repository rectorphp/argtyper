...
namespace Argtyper202511\Rector\Doctrine\Dbal36\Rector\MethodCall;
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, new ObjectType('Argtyper202511\\Doctrine\\DBAL\\Query\\QueryBuilder'))) {
            return null;
        }
