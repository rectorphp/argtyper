...
CODE_SAMPLE
    ...
    private function refactorClassMethod(ClassMethod $classMethod): ?ClassMethod
    {
        ...
        if (!$this->isName($classMethod->returnType, 'Argtyper202601\Doctrine\ORM\Internal\Hydration\IterableResult')) {
            return null;
        }
    ...
    private function refactorForeach(Foreach_ $foreach): ?Foreach_
    {
        ...
        if (!$foreachedExprType->isInstanceOf('Argtyper202601\Doctrine\ORM\Internal\Hydration\IterableResult')->yes()) {
            return null;
        }
