...
namespace Argtyper202511\Rector\Doctrine\Dbal40\Rector\MethodCall;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        if (!$this->nodeTypeResolver->isObjectType($node->var, new ObjectType('Argtyper202511\\Doctrine\\DBAL\\Query\\Expression\\CompositeExpression'))) {
            return null;
        }
