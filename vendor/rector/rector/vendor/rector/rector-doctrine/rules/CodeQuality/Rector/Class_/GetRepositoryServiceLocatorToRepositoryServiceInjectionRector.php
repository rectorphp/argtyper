...
use Argtyper202511\Rector\Doctrine\Enum\TestClass;
use Argtyper202511\Rector\Doctrine\NodeAnalyzer\RepositoryClassResolver;
...
final class GetRepositoryServiceLocatorToRepositoryServiceInjectionRector extends AbstractRector
{
    ...
    /**
     * @readonly
     * @var \Rector\Doctrine\NodeAnalyzer\RepositoryClassResolver
     */
    private $repositoryClassResolver;
    /**
     * @readonly
