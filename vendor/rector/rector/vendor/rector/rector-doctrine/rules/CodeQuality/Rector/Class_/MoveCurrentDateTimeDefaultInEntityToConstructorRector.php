...
use Argtyper202511\Rector\Doctrine\NodeAnalyzer\ConstructorAssignPropertyAnalyzer;
use Argtyper202511\Rector\Doctrine\NodeFactory\ValueAssignFactory;
use Argtyper202511\Rector\Doctrine\NodeManipulator\ConstructorManipulator;
...
CODE_SAMPLE
    ...
    private function refactorProperty(Property $property, Class_ $class) : void
    {
        ...
        $doctrineAnnotationTagValueNode = $phpDocInfo->getByAnnotationClass('Argtyper202511\\Doctrine\\ORM\\Mapping\\Column');
