...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(RenameClassRector::class, ['Argtyper202601\Doctrine\ORM\ORMException' => 'Argtyper202601\Doctrine\ORM\Exception\ORMException']);
};
