...
use Argtyper202511\Rector\Doctrine\NodeAnalyzer\TargetEntityResolver;
...
final class ToOneRelationPropertyTypeResolver
{
    ...
    private const JOIN_COLUMN = ['Argtyper202511\\Doctrine\\ORM\\Mapping\\JoinColumn', 'Argtyper202511\\Doctrine\\ORM\\Mapping\\Column'];
    ...
    {
        $joinDoctrineAnnotationTagValueNode = $phpDocInfo->findOneByAnnotationClass('Argtyper202511\\Doctrine\\ORM\\Mapping\\JoinColumn');
