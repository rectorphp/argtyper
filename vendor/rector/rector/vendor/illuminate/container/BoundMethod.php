...
class BoundMethod
{
    ...
    protected static function callBoundMethod($container, $callback, $default)
    {
        if (!is_array($callback)) {
            return \RectorPrefix202511\Illuminate\Container\Util::unwrapIfClosure($default);
        }
    ...
    protected static function addDependencyForCallParameter($container, $parameter, array &$parameters, &$dependencies)
    {
        ...
        } elseif ($attribute = \RectorPrefix202511\Illuminate\Container\Util::getContextualAttributeFromDependency($parameter)) {
            $pendingDependencies[] = $container->resolveFromAttribute($attribute);
        } elseif (!is_null($className = \RectorPrefix202511\Illuminate\Container\Util::getParameterClassName($parameter))) {
