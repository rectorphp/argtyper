 ...
 */
namespace Argtyper202511\RectorPrefix202511\Symfony\Component\Process;

use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Exception\InvalidArgumentException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Exception\LogicException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Exception\ProcessFailedException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Exception\ProcessSignaledException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Exception\ProcessTimedOutException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Exception\RuntimeException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Pipes\UnixPipes;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Process\Pipes\WindowsPipes;
/**
...
class Process implements \IteratorAggregate
{
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('Argtyper202511\proc_open') && !\function_exists('Argtyper202511\RectorPrefix202511\proc_open')) {
    ...
    protected function isSigchildEnabled(): bool
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('Argtyper202511\phpinfo') && !\function_exists('Argtyper202511\RectorPrefix202511\phpinfo')) {
