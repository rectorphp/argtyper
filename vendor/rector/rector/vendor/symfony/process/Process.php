...
use RectorPrefix202511\Symfony\Component\Process\Exception\ProcessSignaledException;
use RectorPrefix202511\Symfony\Component\Process\Exception\ProcessTimedOutException;
use RectorPrefix202511\Symfony\Component\Process\Exception\RuntimeException;
use RectorPrefix202511\Symfony\Component\Process\Pipes\UnixPipes;
use RectorPrefix202511\Symfony\Component\Process\Pipes\WindowsPipes;
/**
...
class Process implements \IteratorAggregate
{
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('Argtyper202511\proc_open') && !\function_exists('RectorPrefix202511\proc_open')) {
    ...
    public function setInput($input)
    {
        ...
        $this->input = \RectorPrefix202511\Symfony\Component\Process\ProcessUtils::validateInput(__METHOD__, $input);
        return $this;
    }
    /**
    ...
    protected function isSigchildEnabled(): bool
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('Argtyper202511\phpinfo') && !\function_exists('RectorPrefix202511\phpinfo')) {
    ...
    private function prepareWindowsCommandLine(string $cmd, array &$env): string
    {
        ...
        static $comSpec;
        if (!$comSpec && $comSpec = (new \RectorPrefix202511\Symfony\Component\Process\ExecutableFinder())->find('cmd.exe')) {
