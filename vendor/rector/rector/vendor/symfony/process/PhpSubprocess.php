 ...
 */
class PhpSubprocess extends \RectorPrefix202512\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \RectorPrefix202512\Symfony\Component\Process\PhpExecutableFinder();
