 ...
 */
class PhpSubprocess extends \RectorPrefix202511\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \RectorPrefix202511\Symfony\Component\Process\PhpExecutableFinder();
