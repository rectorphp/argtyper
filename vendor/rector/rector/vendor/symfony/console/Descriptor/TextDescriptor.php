 ...
 * @internal
 */
class TextDescriptor extends \RectorPrefix202511\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    protected function describeApplication(Application $application, array $options = []): void
    {
        ...
        $description = new \RectorPrefix202511\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace);
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            foreach ($namespaces as $namespace) {
                ...
                if (!$describedNamespace && \RectorPrefix202511\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                    $this->writeText("\n");
