...
class ReStructuredTextDescriptor extends \RectorPrefix202511\Symfony\Component\Console\Descriptor\Descriptor
{
    // <h1>
    /**
     * @var string
    ...
    {
        $description = new \RectorPrefix202511\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $options['namespace'] ?? null);
    ...
    private function createTableOfContents(\RectorPrefix202511\Symfony\Component\Console\Descriptor\ApplicationDescription $description, Application $application): void
    {
    ...
    private function setVisibleNamespaces(\RectorPrefix202511\Symfony\Component\Console\Descriptor\ApplicationDescription $description): void
    {
