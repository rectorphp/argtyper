 ...
 * @internal
 */
class MarkdownDescriptor extends \RectorPrefix202511\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    protected function describeApplication(Application $application, array $options = []): void
    {
        ...
        foreach ($description->getNamespaces() as $namespace) {
            if (\RectorPrefix202511\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                $this->write("\n\n");
