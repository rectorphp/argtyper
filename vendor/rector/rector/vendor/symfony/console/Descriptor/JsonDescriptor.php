 ...
 * @internal
 */
class JsonDescriptor extends \RectorPrefix202512\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    protected function describeApplication(Application $application, array $options = []): void
    {
        ...
        $description = new \RectorPrefix202512\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
