...
use Argtyper202511\RectorPrefix202511\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    public const DEFAULT_COLOR_MODE = AnsiColorMode::Ansi4;
    /**
     * @var \RectorPrefix202511\Symfony\Component\Console\Output\AnsiColorMode|null
     */
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('Argtyper202511\shell_exec') && !\function_exists('Argtyper202511\RectorPrefix202511\shell_exec')) {
            return \false;
        }
