...
class Terminal
{
    ...
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\Output\AnsiColorMode|null
     */
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('Argtyper202601\shell_exec') && !\function_exists('RectorPrefix202512\shell_exec')) {
            return \false;
        }
