 ...
 */
class OutputFormatter implements \RectorPrefix202511\Symfony\Component\Console\Formatter\WrappableOutputFormatterInterface
{
    /**
     * @var bool
     */
    ...
    private $styles = [];
    /**
     * @var \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyleStack
     */
    private $styleStack;
    ...
    public function __construct(bool $decorated = \false, array $styles = [])
    {
        ...
        $this->setStyle('error', new \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyle('white', 'red'));
        $this->setStyle('info', new \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyle('green'));
        $this->setStyle('comment', new \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyle('yellow'));
        $this->setStyle('question', new \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyle('black', 'cyan'));
        foreach ($styles as $name => $style) {
            $this->setStyle($name, $style);
        }
        $this->styleStack = new \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyleStack();
    }
    /**
     * @return void
     */
     ...
     * @return void
     */
    public function setStyle(string $name, \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface $style)
    {
    ...
    public function getStyleStack(): \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyleStack
    {
     ...
     */
    private function createStyleFromString(string $string): ?\RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
    {
        ...
        $style = new \RectorPrefix202511\Symfony\Component\Console\Formatter\OutputFormatterStyle();
