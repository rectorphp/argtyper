...
class HelperSet implements \IteratorAggregate
{
     ...
     * @return void
     */
    public function set(\RectorPrefix202511\Symfony\Component\Console\Helper\HelperInterface $helper, ?string $alias = null)
    {
     ...
     */
    public function get(string $name): \RectorPrefix202511\Symfony\Component\Console\Helper\HelperInterface
    {
        if (!$this->has($name)) {
