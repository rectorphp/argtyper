...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if (isset($options['style']) && !$options['style'] instanceof \RectorPrefix202511\Symfony\Component\Console\Helper\TableCellStyle) {
    ...
    public function getStyle(): ?\RectorPrefix202511\Symfony\Component\Console\Helper\TableCellStyle
    {
