...
final class TerminalInputHelper
{
    ...
    {
        if (!\function_exists('pcntl_async_signals') && !\function_exists('Argtyper202511\pcntl_async_signals') || !\function_exists('pcntl_signal') && !\function_exists('Argtyper202511\RectorPrefix202511\pcntl_signal')) {
            return;
        }
