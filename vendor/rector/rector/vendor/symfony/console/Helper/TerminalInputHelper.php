...
final class TerminalInputHelper
{
    ...
    {
        if (!\function_exists('pcntl_async_signals') && !\function_exists('Argtyper202601\pcntl_async_signals') || !\function_exists('pcntl_signal') && !\function_exists('RectorPrefix202512\pcntl_signal')) {
            return;
        }
