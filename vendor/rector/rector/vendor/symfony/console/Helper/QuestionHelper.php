 ...
 */
class QuestionHelper extends \RectorPrefix202512\Symfony\Component\Console\Helper\Helper
{
    /**
     * @var resource|null
     */
    ...
    private function autocomplete(OutputInterface $output, Question $question, $inputStream, callable $autocomplete): string
    {
        ...
        $inputHelper = new \RectorPrefix202512\Symfony\Component\Console\Helper\TerminalInputHelper($inputStream);
     ...
     * @param resource $inputStream
     */
    private function doReadInput($inputStream, ?string $exitChar = null, ?\RectorPrefix202512\Symfony\Component\Console\Helper\TerminalInputHelper $helper = null): string
    {
        $ret = '';
        $helper = $helper ?? new \RectorPrefix202512\Symfony\Component\Console\Helper\TerminalInputHelper($inputStream, \false);
        while (!feof($inputStream)) {
            $helper->waitForInput();
