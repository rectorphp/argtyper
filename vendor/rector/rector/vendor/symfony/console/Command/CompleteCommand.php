...
use RectorPrefix202512\Symfony\Component\Console\Completion\Output\BashCompletionOutput;
use RectorPrefix202512\Symfony\Component\Console\Completion\Output\CompletionOutputInterface;
use RectorPrefix202512\Symfony\Component\Console\Completion\Output\FishCompletionOutput;
use RectorPrefix202512\Symfony\Component\Console\Completion\Output\ZshCompletionOutput;
 ...
 */
final class CompleteCommand extends \RectorPrefix202512\Symfony\Component\Console\Command\Command
{
        ...
        try {
            ...
            if (null === $command) {
                ...
                if (CompletionInput::TYPE_OPTION_NAME === $completionInput->getCompletionType()) {
                    $this->log('  Completing option names for the <comment>' . get_class($command instanceof \RectorPrefix202512\Symfony\Component\Console\Command\LazyCommand ? $command->getCommand() : $command) . '</> command.');
                    $suggestions->suggestOptions($command->getDefinition()->getOptions());
                } else {
                    $this->log(['  Completing using the <comment>' . get_class($command instanceof \RectorPrefix202512\Symfony\Component\Console\Command\LazyCommand ? $command->getCommand() : $command) . '</> class.', '  Completing <comment>' . $completionInput->getCompletionType() . '</> for <comment>' . $completionInput->getCompletionName() . '</>']);
    ...
    private function findCommand(CompletionInput $completionInput, OutputInterface $output): ?\RectorPrefix202512\Symfony\Component\Console\Command\Command
    {
        try {
