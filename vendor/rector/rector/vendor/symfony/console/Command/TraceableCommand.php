 ...
 */
final class TraceableCommand extends \RectorPrefix202512\Symfony\Component\Console\Command\Command implements \RectorPrefix202512\Symfony\Component\Console\Command\SignalableCommandInterface
{
    /**
     * @readonly
     * @var \RectorPrefix202512\Symfony\Component\Stopwatch\Stopwatch
     */
    private $stopwatch;
    /**
     * @readonly
     * @var \RectorPrefix202512\Symfony\Component\Console\Command\Command
     */
    public $command;
    /**
     * @var int
    ...
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\Input\InputInterface
     */
    public $input;
    /**
    ...
    public function __construct(\RectorPrefix202512\Symfony\Component\Console\Command\Command $command, Stopwatch $stopwatch)
    {
        $this->stopwatch = $stopwatch;
        if ($command instanceof \RectorPrefix202512\Symfony\Component\Console\Command\LazyCommand) {
        ...
        }, $command, \RectorPrefix202512\Symfony\Component\Console\Command\Command::class)();
        if (\is_callable($code)) {
            $this->setCode($code);
        }
        if ($processTitle) {
    ...
    {
        return $this->command instanceof \RectorPrefix202512\Symfony\Component\Console\Command\SignalableCommandInterface ? $this->command->getSubscribedSignals() : [];
    }
    /**
    ...
    {
        if (!$this->command instanceof \RectorPrefix202512\Symfony\Component\Console\Command\SignalableCommandInterface) {
            return \false;
        }
    ...
    {
        if (!$this->isInteractive = \RectorPrefix202512\Symfony\Component\Console\Command\Command::class !== (new \ReflectionMethod($this->command, 'interact'))->getDeclaringClass()->getName()) {
            return;
        }
