 ...
 */
final class TraceableCommand extends \RectorPrefix202511\Symfony\Component\Console\Command\Command implements \RectorPrefix202511\Symfony\Component\Console\Command\SignalableCommandInterface
{
    /**
     * @readonly
     * @var \RectorPrefix202511\Symfony\Component\Stopwatch\Stopwatch
     */
    private $stopwatch;
    /**
     * @readonly
     * @var \RectorPrefix202511\Symfony\Component\Console\Command\Command
     */
    public $command;
    /**
     * @var int
    ...
    public function __construct(\RectorPrefix202511\Symfony\Component\Console\Command\Command $command, Stopwatch $stopwatch)
    {
        $this->stopwatch = $stopwatch;
        if ($command instanceof \RectorPrefix202511\Symfony\Component\Console\Command\LazyCommand) {
        ...
        }, $command, \RectorPrefix202511\Symfony\Component\Console\Command\Command::class)();
        if (\is_callable($code)) {
            $this->setCode($code);
        }
        if ($processTitle) {
    ...
    {
        return $this->command instanceof \RectorPrefix202511\Symfony\Component\Console\Command\SignalableCommandInterface ? $this->command->getSubscribedSignals() : [];
    }
    /**
    ...
    {
        if (!$this->command instanceof \RectorPrefix202511\Symfony\Component\Console\Command\SignalableCommandInterface) {
            return \false;
        }
    ...
    {
        if (!$this->isInteractive = \RectorPrefix202511\Symfony\Component\Console\Command\Command::class !== (new \ReflectionMethod($this->command, 'interact'))->getDeclaringClass()->getName()) {
            return;
        }
