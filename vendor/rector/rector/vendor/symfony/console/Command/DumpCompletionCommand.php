 ...
 */
final class DumpCompletionCommand extends \RectorPrefix202511\Symfony\Component\Console\Command\Command
{
    /**
...
EOH
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->write(str_replace(['{{ COMMAND_NAME }}', '{{ VERSION }}'], [$commandName, \RectorPrefix202511\Symfony\Component\Console\Command\CompleteCommand::COMPLETION_API_VERSION], file_get_contents($completionFile)));
        return 0;
    }
