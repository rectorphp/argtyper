...
use RectorPrefix202512\Symfony\Component\Console\Command\CompleteCommand;
use RectorPrefix202512\Symfony\Component\Console\Command\DumpCompletionCommand;
use RectorPrefix202512\Symfony\Component\Console\Command\HelpCommand;
use RectorPrefix202512\Symfony\Component\Console\Command\LazyCommand;
use RectorPrefix202512\Symfony\Component\Console\Command\ListCommand;
use RectorPrefix202512\Symfony\Component\Console\Command\SignalableCommandInterface;
use RectorPrefix202512\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use RectorPrefix202512\Symfony\Component\Console\Event\ConsoleCommandEvent;
use RectorPrefix202512\Symfony\Component\Console\Event\ConsoleErrorEvent;
use RectorPrefix202512\Symfony\Component\Console\Event\ConsoleSignalEvent;
use RectorPrefix202512\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use RectorPrefix202512\Symfony\Component\Console\Exception\CommandNotFoundException;
use RectorPrefix202512\Symfony\Component\Console\Exception\ExceptionInterface;
use RectorPrefix202512\Symfony\Component\Console\Exception\LogicException;
use RectorPrefix202512\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use RectorPrefix202512\Symfony\Component\Console\Helper\DebugFormatterHelper;
use RectorPrefix202512\Symfony\Component\Console\Helper\DescriptorHelper;
use RectorPrefix202512\Symfony\Component\Console\Helper\FormatterHelper;
...
use RectorPrefix202512\Symfony\Component\Console\Helper\ProcessHelper;
use RectorPrefix202512\Symfony\Component\Console\Helper\QuestionHelper;
use RectorPrefix202512\Symfony\Component\Console\Input\ArgvInput;
use RectorPrefix202512\Symfony\Component\Console\Input\ArrayInput;
use RectorPrefix202512\Symfony\Component\Console\Input\InputArgument;
use RectorPrefix202512\Symfony\Component\Console\Input\InputAwareInterface;
...
use RectorPrefix202512\Symfony\Component\Console\Output\ConsoleOutput;
...
use RectorPrefix202512\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use RectorPrefix202512\Symfony\Component\Console\Style\SymfonyStyle;
use RectorPrefix202512\Symfony\Component\ErrorHandler\ErrorHandler;
use RectorPrefix202512\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
...
class Application implements ResetInterface
{
    ...
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\Command\Command|null
     */
    ...
    private $version;
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\CommandLoader\CommandLoaderInterface|null
     */
    ...
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\Input\InputDefinition
     */
    private $definition;
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\Helper\HelperSet
     */
    private $helperSet;
    /**
     * @var \RectorPrefix202512\Symfony\Contracts\EventDispatcher\EventDispatcherInterface|null
     */
    private $dispatcher;
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\Terminal
     */
    private $terminal;
    /**
     * @var string
    ...
    /**
     * @var \RectorPrefix202512\Symfony\Component\Console\SignalRegistry\SignalRegistry|null
     */
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN')
    {
        ...
        $this->terminal = new \RectorPrefix202512\Symfony\Component\Console\Terminal();
            ...
            if ($e instanceof CommandNotFoundException && !$e instanceof NamespaceNotFoundException && 1 === \count($alternatives = $e->getAlternatives()) && $input->isInteractive()) {
                ...
                if (!$style->confirm(\sprintf('Do you want to run "%s" instead? ', $alternative), \false)) {
                    if (null !== $this->dispatcher) {
                        ...
                        $this->dispatcher->dispatch($event, \RectorPrefix202512\Symfony\Component\Console\ConsoleEvents::ERROR);
    ...
    protected function doRunCommand(Command $command, InputInterface $input, OutputInterface $output)
    {
            ...
            if ($this->dispatcher) {
                ...
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal) use ($event, $command, $commandSignals) {
                        $this->dispatcher->dispatch($event, \RectorPrefix202512\Symfony\Component\Console\ConsoleEvents::SIGNAL);
                        ...
                        if (\false !== $exitCode) {
                            ...
                            $this->dispatcher->dispatch($event, \RectorPrefix202512\Symfony\Component\Console\ConsoleEvents::TERMINATE);
        ...
        $e = null;
        try {
            $this->dispatcher->dispatch($event, \RectorPrefix202512\Symfony\Component\Console\ConsoleEvents::COMMAND);
