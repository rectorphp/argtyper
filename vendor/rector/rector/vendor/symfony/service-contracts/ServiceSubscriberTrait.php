...
trigger_deprecation('symfony/contracts', 'v3.5', '"%s" is deprecated, use "ServiceMethodsSubscriberTrait" instead.', \RectorPrefix202511\Symfony\Contracts\Service\ServiceSubscriberTrait::class);
/**
