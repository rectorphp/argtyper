 ...
 */
namespace Argtyper202511\RectorPrefix202511\Symfony\Component\Yaml;

use Argtyper202511\RectorPrefix202511\Symfony\Component\Yaml\Exception\DumpException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Yaml\Exception\ParseException;
use Argtyper202511\RectorPrefix202511\Symfony\Component\Yaml\Tag\TaggedValue;
/**
            ...
            case \in_array($scalar[0], ['+', '-', '.'], \true) || \is_numeric($scalar[0]):
                ...
                switch (\true) {
                    ...
                    case Parser::preg_match(self::getTimestampRegex(), $scalar):
                        ...
                        } catch (\Argtyper202511\DateRangeError|\ValueError $exception) {
                            // no-op
                        }
