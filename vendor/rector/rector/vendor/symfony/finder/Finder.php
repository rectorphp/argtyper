...
use RectorPrefix202512\Symfony\Component\Finder\Comparator\DateComparator;
use RectorPrefix202512\Symfony\Component\Finder\Comparator\NumberComparator;
use RectorPrefix202512\Symfony\Component\Finder\Exception\DirectoryNotFoundException;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\CustomFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\DateRangeFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\DepthRangeFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\ExcludeDirectoryFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\FilecontentFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\FilenameFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\LazyIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\SizeRangeFilterIterator;
use RectorPrefix202512\Symfony\Component\Finder\Iterator\SortableIterator;
/**
...
class Finder implements \IteratorAggregate, \Countable
{
    ...
    {
        $this->mode = \RectorPrefix202512\Symfony\Component\Finder\Iterator\FileTypeFilterIterator::ONLY_DIRECTORIES;
        return $this;
    }
    /**
    ...
    {
        $this->mode = \RectorPrefix202512\Symfony\Component\Finder\Iterator\FileTypeFilterIterator::ONLY_FILES;
        return $this;
    }
    /**
    ...
    private function searchInDirectory(string $dir): \Iterator
    {
        ...
        $iterator = new \RectorPrefix202512\Symfony\Component\Finder\Iterator\RecursiveDirectoryIterator($dir, $flags, $this->ignoreUnreadableDirs);
        if ($exclude) {
        ...
        if ($this->mode) {
            $iterator = new \RectorPrefix202512\Symfony\Component\Finder\Iterator\FileTypeFilterIterator($iterator, $this->mode);
        }
        ...
        if ($this->paths || $notPaths) {
            $iterator = new \RectorPrefix202512\Symfony\Component\Finder\Iterator\PathFilterIterator($iterator, $this->paths, $notPaths);
        }
        if (static::IGNORE_VCS_IGNORED_FILES === (static::IGNORE_VCS_IGNORED_FILES & $this->ignore)) {
            $iterator = new \RectorPrefix202512\Symfony\Component\Finder\Iterator\VcsIgnoredFilterIterator($iterator, $dir);
        }
        return $iterator;
    }
    /**
