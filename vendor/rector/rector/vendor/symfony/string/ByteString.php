 ...
 */
class ByteString extends \RectorPrefix202512\Symfony\Component\String\AbstractString
{
    ...
    {
        if ($suffix instanceof \RectorPrefix202512\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \RectorPrefix202512\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \RectorPrefix202512\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($prefix instanceof \RectorPrefix202512\Symfony\Component\String\AbstractString) {
    ...
    public function toUnicodeString(?string $fromEncoding = null): \RectorPrefix202512\Symfony\Component\String\UnicodeString
    {
        return new \RectorPrefix202512\Symfony\Component\String\UnicodeString($this->toCodePointString($fromEncoding)->string);
    }
    public function toCodePointString(?string $fromEncoding = null): \RectorPrefix202512\Symfony\Component\String\CodePointString
    {
        $u = new \RectorPrefix202512\Symfony\Component\String\CodePointString();
    ...
    public function width(bool $ignoreAnsiDecoration = \true): int
    {
        ...
        return (new \RectorPrefix202512\Symfony\Component\String\CodePointString($string))->width($ignoreAnsiDecoration);
    }
}
