...
class ByteString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'Argtyper202511\\1_\\2', $str->string));
        return $str;
    }
    /**
     * @return static
    ...
    public function toCodePointString(?string $fromEncoding = null) : CodePointString
    {
        ...
        try {
            try {
                ...
                if (!\function_exists('iconv') && !\function_exists('Argtyper202511\\RectorPrefix202511\\iconv')) {
                    throw $e;
                }
