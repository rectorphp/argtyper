 ...
 */
final class FrenchInflector implements \RectorPrefix202512\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix202512\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix202512\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix202512\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix202512\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix202512\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix202512\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
