...
abstract class AbstractString implements \JsonSerializable
{
    ...
    public function toByteString(?string $toEncoding = null): \RectorPrefix202511\Symfony\Component\String\ByteString
    {
        $b = new \RectorPrefix202511\Symfony\Component\String\ByteString();
        $toEncoding = \in_array($toEncoding, ['utf8', 'utf-8', 'UTF8'], \true) ? 'UTF-8' : $toEncoding;
        if (null === $toEncoding || $toEncoding === $fromEncoding = $this instanceof \RectorPrefix202511\Symfony\Component\String\AbstractUnicodeString || preg_match('//u', $b->string) ? 'UTF-8' : 'Windows-1252') {
        ...
        try {
            ...
            if (!\function_exists('iconv') && !\function_exists('Argtyper202511\iconv') && !\function_exists('RectorPrefix202511\iconv')) {
    ...
    public function toCodePointString(): \RectorPrefix202511\Symfony\Component\String\CodePointString
    {
        return new \RectorPrefix202511\Symfony\Component\String\CodePointString($this->string);
    }
    public function toString(): string
    {
        return $this->string;
    }
    public function toUnicodeString(): \RectorPrefix202511\Symfony\Component\String\UnicodeString
    {
        return new \RectorPrefix202511\Symfony\Component\String\UnicodeString($this->string);
    }
    /**
     * @return static
     */
     ...
     * @return static
     */
    public function truncate(int $length, string $ellipsis = '', $cut = \RectorPrefix202511\Symfony\Component\String\TruncateMode::Char)
    {
        ...
        if (\RectorPrefix202511\Symfony\Component\String\TruncateMode::WordAfter === $cut || !$cut) {
            if (null === $length = $this->indexOf([' ', "\r", "\n", "\t"], ($length ?: 1) - 1)) {
                return clone $this;
            }
            $length += $ellipsisLength;
        } elseif (\RectorPrefix202511\Symfony\Component\String\TruncateMode::WordBefore === $cut && null !== $this->indexOf([' ', "\r", "\n", "\t"], ($length ?: 1) - 1)) {
            $length += $ellipsisLength;
        }
        $str = $this->slice(0, $length - $ellipsisLength);
        if (\RectorPrefix202511\Symfony\Component\String\TruncateMode::WordBefore === $cut) {
