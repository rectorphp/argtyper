...
final class Rules
{
    ...
    {
        return new Ruleset(new Transformations(...\RectorPrefix202511\Doctrine\Inflector\Rules\NorwegianBokmal\Inflectible::getSingular()), new Patterns(...\RectorPrefix202511\Doctrine\Inflector\Rules\NorwegianBokmal\Uninflected::getSingular()), (new Substitutions(...\RectorPrefix202511\Doctrine\Inflector\Rules\NorwegianBokmal\Inflectible::getIrregular()))->getFlippedSubstitutions());
    }
    public static function getPluralRuleset(): Ruleset
    {
        return new Ruleset(new Transformations(...\RectorPrefix202511\Doctrine\Inflector\Rules\NorwegianBokmal\Inflectible::getPlural()), new Patterns(...\RectorPrefix202511\Doctrine\Inflector\Rules\NorwegianBokmal\Uninflected::getPlural()), new Substitutions(...\RectorPrefix202511\Doctrine\Inflector\Rules\NorwegianBokmal\Inflectible::getIrregular()));
    }
}
