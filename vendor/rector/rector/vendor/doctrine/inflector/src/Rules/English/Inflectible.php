...
namespace Argtyper202511\RectorPrefix202511\Doctrine\Inflector\Rules\English;

use Argtyper202511\RectorPrefix202511\Doctrine\Inflector\Rules\Pattern;
use Argtyper202511\RectorPrefix202511\Doctrine\Inflector\Rules\Substitution;
use Argtyper202511\RectorPrefix202511\Doctrine\Inflector\Rules\Transformation;
use Argtyper202511\RectorPrefix202511\Doctrine\Inflector\Rules\Word;
class Inflectible
{
    /** @return Transformation[] */
    public static function getSingular() : iterable
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'Argtyper202511\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'Argtyper202511\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'Argtyper202511\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'Argtyper202511\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'Argtyper202511\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'Argtyper202511\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'Argtyper202511\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'Argtyper202511\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'Argtyper202511\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'Argtyper202511\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'Argtyper202511\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'Argtyper202511\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'Argtyper202511\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'Argtyper202511\\1\\2oes'));
