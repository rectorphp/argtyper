...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\RectorPrefix202512\Doctrine\Inflector\WordInflector $singularizer, \RectorPrefix202512\Doctrine\Inflector\WordInflector $pluralizer)
    {
