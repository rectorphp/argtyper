...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\RectorPrefix202511\Doctrine\Inflector\WordInflector $singularizer, \RectorPrefix202511\Doctrine\Inflector\WordInflector $pluralizer)
    {
