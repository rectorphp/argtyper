...
final class RenameFunctionRector extends AbstractRector implements ConfigurableRectorInterface
{
    ...
    {
        return new RuleDefinition('Turn defined function call new one', [new ConfiguredCodeSample('view("...", []);', 'Laravel\Templating\render("...", []);', ['view' => 'Argtyper202601\Laravel\Templating\render'])]);
    }
    /**
