...
final class SpatieEnumMethodCallToEnumConstRector extends AbstractRector implements MinPhpVersionInterface
{
     ...
     * @var string
     */
    private const SPATIE_FQN = 'Argtyper202511\\Spatie\\Enum\\Enum';
    /**
     * @var string[]
     */
...
CODE_SAMPLE
    ...
    private function refactorMethodCall(MethodCall $methodCall, string $methodName) : ?\Argtyper202511\PhpParser\Node\Expr\PropertyFetch
    {
