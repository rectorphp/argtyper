...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if (!$this->isObjectType($node->class, new ObjectType('Argtyper202601\MyCLabs\Enum\Enum'))) {
            return null;
        }
    ...
    private function isCallerClassEnum($node): bool
    {
        if ($node instanceof StaticCall) {
            return $this->isObjectType($node->class, new ObjectType('Argtyper202601\MyCLabs\Enum\Enum'));
        }
        return $this->isObjectType($node->var, new ObjectType('Argtyper202601\MyCLabs\Enum\Enum'));
    }
    ...
    {
        if (!$this->isObjectType($expr, new ObjectType('Argtyper202601\MyCLabs\Enum\Enum'))) {
            return null;
        }
        return $expr;
    }
    ...
    {
        if (!$this->isObjectType($methodCall->var, new ObjectType('Argtyper202601\MyCLabs\Enum\Enum'))) {
            return null;
        }
