...
final class DoctrineTagAndAnnotationToAttribute
{
    ...
    public function __construct(DoctrineAnnotationTagValueNode $doctrineAnnotationTagValueNode, \Argtyper202511\Rector\Php80\ValueObject\AnnotationToAttribute $annotationToAttribute)
    {
    ...
    public function getAnnotationToAttribute(): \Argtyper202511\Rector\Php80\ValueObject\AnnotationToAttribute
    {
