...
namespace Argtyper202511\Rector\Php80\Rector\NotIdentical;
...
use Argtyper202511\Rector\Php80\NodeResolver\StrFalseComparisonResolver;
...
final class MbStrContainsRector extends AbstractRector implements MinPhpVersionInterface, RelatedPolyfillInterface
{
    /**
     * @readonly
     * @var \Rector\Php80\NodeResolver\StrFalseComparisonResolver
     */
    private $strFalseComparisonResolver;
    /**
     * @var string[]
     */
