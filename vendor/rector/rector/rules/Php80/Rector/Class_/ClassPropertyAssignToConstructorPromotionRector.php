...
use Argtyper202511\Rector\Naming\PropertyRenamer\PropertyPromotionRenamer;
...
use Argtyper202511\Rector\Php80\DocBlock\PropertyPromotionDocBlockMerger;
use Argtyper202511\Rector\Php80\Guard\MakePropertyPromotionGuard;
use Argtyper202511\Rector\Php80\NodeAnalyzer\PromotedPropertyCandidateResolver;
...
final class ClassPropertyAssignToConstructorPromotionRector extends AbstractRector implements MinPhpVersionInterface, ConfigurableRectorInterface
{
     ...
     * @var bool
     */
    private $allowModelBasedClasses = \true;
