...
use Argtyper202511\Rector\Php80\ValueObject\PropertyPromotionCandidate;
...
final class PromotedPropertyCandidateResolver
{
    ...
    public function __construct(NodeNameResolver $nodeNameResolver, BetterNodeFinder $betterNodeFinder, NodeComparator $nodeComparator, PropertyFetchAnalyzer $propertyFetchAnalyzer, PhpDocInfoFactory $phpDocInfoFactory, \Argtyper202511\Rector\Php80\NodeAnalyzer\PhpAttributeAnalyzer $phpAttributeAnalyzer)
    {
