...
final class PropertyNaming
{
     ...
     */
    private const CONTEXT_AWARE_NAMES_BY_TYPE = ['Argtyper202601\Twig\Environment' => 'twigEnvironment'];
    /**
     * @var string
     */
    ...
    public function getExpectedNameFromType(Type $type): ?ExpectedName
    {
        ...
        if ($type instanceof ObjectType) {
            if ($type->isInstanceOf('Argtyper202601\Doctrine\Common\Collections\Collection')->yes()) {
                return null;
            }
            if ($type->isInstanceOf('Argtyper202601\Illuminate\Support\Collection')->yes()) {
                return null;
            }
