...
final class BreakingVariableRenameGuard
{
    ...
    {
        return $this->nodeTypeResolver->isObjectType($param, new ObjectType('Argtyper202601\Ramsey\Uuid\UuidInterface'));
    }
    ...
    private function isGenerator(Param $param): bool
    {
        ...
        return $paramType->isInstanceOf('Argtyper202601\Symfony\Component\DependencyInjection\Argument\RewindableGenerator')->yes();
    }
}
