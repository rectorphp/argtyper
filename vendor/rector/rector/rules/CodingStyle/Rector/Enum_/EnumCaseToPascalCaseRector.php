...
namespace Argtyper202511\Rector\CodingStyle\Rector\Enum_;
...
use Argtyper202511\PHPStan\BetterReflection\Reflector\DefaultReflector;
use Argtyper202511\PHPStan\BetterReflection\Reflector\Exception\IdentifierNotFound;
...
CODE_SAMPLE
    ...
    public function refactorEnum(Enum_ $enum) : ?\Argtyper202511\PhpParser\Node\Stmt\Enum_
    {
    ...
    private function convertToPascalCase(string $name) : string
    {
        ...
        return \implode('', \array_map(function ($part) : string {
            return \ctype_upper($part) ? \ucfirst(\strtolower($part)) : \ucfirst($part);
        }, $parts));
    }
}
