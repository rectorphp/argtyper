...
final class LaravelModelGuard
{
    ...
    {
        if (!$classReflection->is('Argtyper202511\Illuminate\Database\Eloquent\Model')) {
            return \false;
        }
    ...
    private function isAttributeMethod(string $name, ClassMethod $classMethod): bool
    {
        ...
        return $this->nodeTypeResolver->isObjectType($classMethod->returnType, new ObjectType('Argtyper202511\Illuminate\Database\Eloquent\Casts\Attribute'));
    }
    private function isScopeMethod(string $name, ClassMethod $classMethod): bool
    {
        ...
        return $this->phpAttributeAnalyzer->hasPhpAttribute($classMethod, 'Argtyper202511\Illuminate\Database\Eloquent\Attributes\Scope');
    }
}
