...
CODE_SAMPLE
    ...
    private function shouldSkipClassMethod(ClassMethod $classMethod, Class_ $class): bool
    {
        ...
        if ($this->isName($classMethod->name, MethodName::INVOKE) && $this->phpAttributeAnalyzer->hasPhpAttribute($class, 'Argtyper202601\Symfony\Component\Messenger\Attribute\AsMessageHandler')) {
            return \true;
        }
