...
use Argtyper202511\PHPStan\Parser\ArrayMapArgVisitor;
use Argtyper202511\PHPStan\Reflection\ClassReflection;
use Argtyper202511\Rector\NodeCollector\NodeAnalyzer\ArrayCallableMethodMatcher;
use Argtyper202511\Rector\NodeCollector\ValueObject\ArrayCallable;
use Argtyper202511\Rector\NodeCollector\ValueObject\ArrayCallableDynamicMethod;
...
final class IsClassMethodUsedAnalyzer
{
    ...
    public function __construct(NodeNameResolver $nodeNameResolver, AstResolver $astResolver, BetterNodeFinder $betterNodeFinder, ValueResolver $valueResolver, ArrayCallableMethodMatcher $arrayCallableMethodMatcher, \Argtyper202511\Rector\DeadCode\NodeAnalyzer\CallCollectionAnalyzer $callCollectionAnalyzer, ReflectionResolver $reflectionResolver, SimpleCallableNodeTraverser $simpleCallableNodeTraverser)
    {
    ...
    private function shouldSkipArrayCallable(Class_ $class, ?\Argtyper202511\Rector\NodeCollector\ValueObject\ArrayCallable $arrayCallable): bool
    {
