...
namespace Argtyper202511\Rector\DeadCode\ValueObject;
...
final class BinaryToVersionCompareCondition implements ConditionInterface
{
     ...
     */
    public function __construct(\Argtyper202511\Rector\DeadCode\ValueObject\VersionCompareCondition $versionCompareCondition, string $binaryClass, $expectedValue)
    {
        $this->versionCompareCondition = $versionCompareCondition;
        $this->binaryClass = $binaryClass;
        $this->expectedValue = $expectedValue;
    }
    public function getVersionCompareCondition(): \Argtyper202511\Rector\DeadCode\ValueObject\VersionCompareCondition
    {
