...
namespace Argtyper202511\Rector\Php84\Rector\Foreach_;
...
use Argtyper202511\Rector\Php84\NodeAnalyzer\ForeachKeyUsedInConditionalAnalyzer;
...
final class ForeachToArrayAnyRector extends AbstractRector implements MinPhpVersionInterface
{
    ...
    /**
     * @readonly
     * @var \Rector\Php84\NodeAnalyzer\ForeachKeyUsedInConditionalAnalyzer
     */
    private $foreachKeyUsedInConditionalAnalyzer;
    /**
     * @readonly
     * @var \Rector\NodeManipulator\StmtsManipulator
     */
    private $stmtsManipulator;
    public function __construct(ValueResolver $valueResolver, ForeachKeyUsedInConditionalAnalyzer $foreachKeyUsedInConditionalAnalyzer, StmtsManipulator $stmtsManipulator)
    {
