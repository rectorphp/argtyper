...
CODE_SAMPLE
    ...
    {
        return new StaticCall(new FullyQualified('Argtyper202511\Carbon\Carbon'), 'now');
    }
    private function createCarbonParseTimestamp(Expr $dateExpr): MethodCall
    {
        $staticCall = new StaticCall(new FullyQualified('Argtyper202511\Carbon\Carbon'), 'parse', [new Arg($dateExpr)]);
    ...
    {
        $staticCall = new StaticCall(new FullyQualified('Argtyper202511\Carbon\Carbon'), 'createFromTimestamp', [new Arg($timestampExpr)]);
        return new MethodCall($staticCall, 'format', [new Arg($format)]);
    }
    /**
    ...
    {
        $staticCall = new StaticCall(new FullyQualified('Argtyper202511\Carbon\Carbon'), 'now');
