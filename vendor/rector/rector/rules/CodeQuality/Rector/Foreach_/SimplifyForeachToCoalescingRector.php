...
namespace Argtyper202511\Rector\CodeQuality\Rector\Foreach_;
...
CODE_SAMPLE
    ...
    private function processForeachNodeWithReturnInside(Foreach_ $foreach, Return_ $innerForeachReturn, ?Stmt $nextStmt) : ?\Argtyper202511\PhpParser\Node\Stmt\Return_
    {
