...
namespace Argtyper202511\Rector\TypeDeclaration\PHPStan;
...
use Argtyper202511\PHPStan\Type\Generic\TemplateTypeFactory;
use Argtyper202511\PHPStan\Type\Generic\TemplateTypeScope;
...
use Argtyper202511\Rector\StaticTypeMapper\ValueObject\Type\ShortenedGenericObjectType;
...
final class ObjectTypeSpecifier
{
     ...
     */
    public function narrowToFullyQualifiedOrAliasedObjectType(Node $node, ObjectType $objectType, ?\Argtyper202511\PHPStan\Analyser\Scope $scope, bool $withPreslash = \false)
    {
