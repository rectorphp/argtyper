...
final class AutowiredClassMethodOrPropertyAnalyzer
{
    ...
    public function detect($node): bool
    {
        ...
        return $this->phpAttributeAnalyzer->hasPhpAttributes($node, ['Argtyper202601\Symfony\Contracts\Service\Attribute\Required', 'Argtyper202601\Nette\DI\Attributes\Inject']);
    }
}
