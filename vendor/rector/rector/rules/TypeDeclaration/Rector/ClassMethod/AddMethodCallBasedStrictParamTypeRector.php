...
use Argtyper202511\Rector\TypeDeclaration\NodeAnalyzer\ClassMethodParamTypeCompleter;
use Argtyper202511\Rector\TypeDeclarationDocblocks\PrivateMethodFlagger;
...
final class AddMethodCallBasedStrictParamTypeRector extends AbstractRector
{
    ...
    /**
     * @readonly
     * @var \Rector\TypeDeclarationDocblocks\PrivateMethodFlagger
     */
    private $privateMethodFlagger;
    /**
     * @var int
     */
