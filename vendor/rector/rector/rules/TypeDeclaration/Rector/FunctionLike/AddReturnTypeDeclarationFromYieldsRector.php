...
use Argtyper202511\Rector\TypeDeclarationDocblocks\NodeFinder\YieldNodeFinder;
use Argtyper202511\Rector\TypeDeclarationDocblocks\TypeResolver\YieldTypeResolver;
...
final class AddReturnTypeDeclarationFromYieldsRector extends AbstractRector implements MinPhpVersionInterface
{
    ...
    /**
     * @readonly
     * @var \Rector\TypeDeclarationDocblocks\NodeFinder\YieldNodeFinder
     */
    private $yieldNodeFinder;
    /**
     * @readonly
     * @var \Rector\TypeDeclarationDocblocks\TypeResolver\YieldTypeResolver
     */
    private $yieldTypeResolver;
