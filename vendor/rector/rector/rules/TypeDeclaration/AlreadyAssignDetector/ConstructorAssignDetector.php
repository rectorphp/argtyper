...
use Argtyper202511\Rector\NodeDecorator\StatementDepthAttributeDecorator;
...
use Argtyper202511\Rector\TypeDeclaration\Matcher\PropertyAssignMatcher;
...
final class ConstructorAssignDetector
{
    ...
    private function matchInitializeClassMethod(ClassLike $classLike) : array
    {
        ...
        $testCaseObjectType = new ObjectType('Argtyper202511\\PHPUnit\\Framework\\TestCase');
