...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(StaticCallToFuncCallRector::class, [new StaticCallToFuncCall('Argtyper202601\Nette\Utils\Strings', 'startsWith', 'str_starts_with'), new StaticCallToFuncCall('Argtyper202601\Nette\Utils\Strings', 'endsWith', 'str_ends_with'), new StaticCallToFuncCall('Argtyper202601\Nette\Utils\Strings', 'contains', 'str_contains')]);
    // nette\utils and Strings::replace()
    $rectorConfig->ruleWithConfiguration(ArgumentAdderRector::class, [new ArgumentAdder('Argtyper202601\Nette\Utils\Strings', 'replace', 2, 'replacement', '')]);
