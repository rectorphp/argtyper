...
final class ArgTyperCommand extends Command
{
    ...
    private function runPhpStan(array $projectDirs, string $projectPath, bool $isDebug) : void
    {
        ...
        $cmd = \sprintf('vendor/bin/phpstan analyse %s --configuration=%s --autoload-file=%s', \implode(' ', $dirs), 'phpstan-data-collector.neon', \escapeshellarg($projectPath . '/vendor/autoload.php'));
    ...
    private function runRector(array $projectDirs, bool $isDebug) : void
    {
        ...
        $cmd = \sprintf('vendor/bin/rector process %s --config=%s --clear-cache', \implode(' ', $projectDirs), 'rector-argtyper.php');
