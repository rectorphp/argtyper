...
use SherlockTypes202308\PhpParser\Node\Expr\MethodCall;
use SherlockTypes202308\PhpParser\Node\Identifier;
use SherlockTypes202308\PHPStan\Analyser\Scope;
use SherlockTypes202308\PHPStan\Collectors\Collector;
use SherlockTypes202308\PHPStan\Type\IntersectionType;
use SherlockTypes202308\PHPStan\Type\TypeWithClassName;
use SherlockTypes202308\PHPStan\Type\UnionType;
...
final class PHPUnitAssertMethodCallCollector implements Collector
{
    ...
    public function processNode(Node $node, Scope $scope) : ?array
    {
        ...
        if (!\in_array($methodCallName, ['assertSame', 'assertEquals'], \true)) {
            return null;
        }
